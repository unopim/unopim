<x-admin::layouts>
    <x-slot:title>
        @lang('ai-agent::app.credentials.edit-title')
    </x-slot:title>

    <v-credential-edit />

    @pushOnce('scripts')
        <script type="text/x-template" id="v-credential-edit-template">
            <x-admin::form
                v-slot="{ meta, errors, handleSubmit }"
                as="div"
            >
                <form @submit="handleSubmit($event, update)" ref="credentialEditForm">
                    <!-- Header -->
                            ...
                            <div class="p-4 bg-white dark:bg-cherry-900 box-shadow rounded">
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        name="label"
                                        rules="required"
                                        value="{{ old('label') ?: $credential->label }}"
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        name="provider"
                                        rules="required"
                                        value="{{ old('provider') ?: $credential->provider }}"
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        name="apiUrl"
                                        rules="required|url"
                                        value="{{ old('apiUrl') ?: $credential->apiUrl }}"
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        name="model"
                                        rules="required"
                                        value="{{ old('model') ?: $credential->model }}"
                                ...
                                <x-slot:content>
                                    ...
                                    <x-admin::form.control-group class="!mb-0">
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            :checked="(bool) $credential->status"
                                        />
        ...
        <script type="module">
            app.component('v-credential-edit', {
                template: '#v-credential-edit-template',
                ...
                methods: {
                    ...
                    update(params, { resetForm, setErrors }) {
                        ...
                        this.$axios.post("{{ route('ai-agent.credentials.update', $credential->id) }}", params)
                            .then((response) => {
