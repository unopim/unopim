<x-admin::layouts>
    <x-slot:title>
        @lang('ai-agent::app.agents.edit-title')
    </x-slot:title>

    <v-agent-edit />

    @pushOnce('scripts')
        <script type="text/x-template" id="v-agent-edit-template">
            <x-admin::form
                v-slot="{ meta, errors, handleSubmit }"
                as="div"
            >
                <form @submit="handleSubmit($event, update)" ref="agentEditForm">
                    <!-- Header -->
                    ...
                    <div class="flex gap-2.5 mt-3.5 max-xl:flex-wrap">
                            ...
                            <div class="p-4 bg-white dark:bg-cherry-900 box-shadow rounded">
                                ...
                                <x-admin::form.control-group>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        name="systemPrompt"
                                        rows="8"
                                        value="{{ old('systemPrompt') ?: $agent->systemPrompt }}"
                        ...
                        <div class="flex flex-col gap-2 w-[360px] max-w-full max-sm:w-full">
                            <!-- Credential -->
                            <x-admin::accordion :title="trans('ai-agent::app.agents.fields.credential')">
                                ...
                                <x-slot:content>
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            name="credentialId"
                                            rules="required"
                                            value="{{ old('credentialId') ?: $agent->credentialId }}"
                            ...
                            <!-- Settings -->
                            <x-admin::accordion :title="trans('ai-agent::app.agents.settings')">
                                ...
                                <x-slot:content>
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control
                                            type="text"
                                            name="maxTokens"
                                            value="{{ old('maxTokens') ?: $agent->maxTokens }}"
        ...
        <script type="module">
            app.component('v-agent-edit', {
                template: '#v-agent-edit-template',
                ...
                methods: {
                    ...
                    update(params, { resetForm, setErrors }) {
                        ...
                        this.$axios.post("{{ route('ai-agent.agents.update', $agent->id) }}", params)
                            .then((response) => {
