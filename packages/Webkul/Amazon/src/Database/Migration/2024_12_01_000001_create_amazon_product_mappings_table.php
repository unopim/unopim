...
return new class extends Migration
{
    ...
    {
        Schema::create('amazon_product_mappings', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['product_id', 'connector_id'], 'amazon_product_connector_unique');
    ...
    {
        Schema::dropIfExists('amazon_product_mappings');
    }
};
