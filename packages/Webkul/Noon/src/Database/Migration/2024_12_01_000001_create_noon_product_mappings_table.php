...
return new class extends Migration
{
    ...
    {
        Schema::create('noon_product_mappings', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['product_id', 'connector_id'], 'noon_product_connector_unique');
    ...
    {
        Schema::dropIfExists('noon_product_mappings');
    }
};
