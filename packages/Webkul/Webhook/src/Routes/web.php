...
use Webkul\Webhook\Http\Controllers\LogsController;
use Webkul\Webhook\Http\Controllers\SettingsController;
...
Route::group(['middleware' => ['admin'], 'prefix' => config('app.admin_url')], function () {
    Route::prefix('webhook')->group(function () {
        ...
        Route::get('history', [SettingsController::class, 'listHistory'])->name('webhook.settings.history.get');
