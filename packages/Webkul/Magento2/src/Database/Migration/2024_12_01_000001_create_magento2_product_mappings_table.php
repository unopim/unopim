...
return new class extends Migration
{
    ...
    {
        Schema::create('magento2_product_mappings', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['product_id', 'connector_id'], 'magento2_product_connector_unique');
    ...
    {
        Schema::dropIfExists('magento2_product_mappings');
    }
};
