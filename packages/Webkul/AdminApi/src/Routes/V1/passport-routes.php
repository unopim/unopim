...
Route::group(['middleware' => ['auth:api']], function () {
    Route::controller(PassportController::class)->prefix('passports')->group(function () {
        ...
        Route::put('mapping', 'updateMapping')->name('admin.api.passports.mapping.update');
        ...
        Route::post('reinstate/{id}', 'reinstate')->whereNumber('id')->name('admin.api.passports.reinstate');
        Route::post('redact/{id}', 'redact')->whereNumber('id')->name('admin.api.passports.redact');
    });
});
