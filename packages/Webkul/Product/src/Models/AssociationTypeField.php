...
class AssociationTypeField extends TranslatableModel implements AssociationTypeFieldContract, HistoryContract
{
    use HistoryTrait;
    ...
    /**
     * Get the association type that this field belongs to
     */
    ...
    /**
     * Get all of the options for the AssociationTypeField
     */
    ...
    /**
     * Returns association type field value table column based type
     */
    ...
    public function getValidationUniqueField()
    {
        ...
        if ($this->value_per_locale && $this->is_unique) {
            $validation = 'unique:product_associations,additional_data->locale_specific->%s->%s';
        }

        if (! $this->value_per_locale && $this->is_unique) {
            $validation = 'unique:product_associations,additional_data->common->%s';
        }
     ...
     * used while validating association type field values
     */
    public function getValidationRules(?string $currentLocaleCode = null, ?int $id = null, bool $withUniqueValidation = true)
    {
        ...
        if ($this->is_unique && $withUniqueValidation) {
            ...
            $rule = "unique:product_associations,additional_data->{$path}";
