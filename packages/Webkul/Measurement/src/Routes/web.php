...
Route::group(['middleware' => ['web', 'admin'], 'prefix' => 'admin/measurement'], function (): void {
    ...
    Route::controller(MeasurementUnitsController::class)->group(function (): void {
    ...
    Route::get('family-units', [AttributeController::class, 'familyUnits'])->name('admin.measurement.family.units');
