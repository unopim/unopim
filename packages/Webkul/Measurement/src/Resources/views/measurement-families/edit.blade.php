<x-admin::layouts.with-history>
    ...
    <x-slot:pageHeader>
        <x-admin::layouts.edit-page-header
            :title="trans('measurement::app.measurement.edit.measurement_edit').' | '.trans('measurement::app.measurement.edit.name').': '.$family->name"
            :back-url="route('admin.measurement.families.index')"
            :back-label="trans('measurement::app.measurement.edit.back')"
            :save-label="bouncer()->hasPermission('catalog.measurements.families.edit') ? trans('measurement::app.measurement.edit.save') : null"
            form="measurement_family_edit_form"
            :sticky="false"
        />
    </x-slot>

    <x-admin::form
        id="measurement_family_edit_form"
        method="PUT"
                ...
                <div class="relative rounded bg-white p-4 box-shadow dark:bg-cherry-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            rules="required"
                            :placeholder="trans('measurement::app.measurement.index.enter_code')"
                            disabled
                        />
                                ...
                                >
                                    <x-admin::form.control-group class="mb-2 w-1/3">
                                        <x-admin::form.control-group.control
                                            ...
                                            :placeholder="trans('measurement::app.measurement.edit.enter_conversion_value')"
                    ...
                    updateOrCreate(params, { resetForm, setErrors }) {
                        ...
                        .then((response) => {
                            ...
                            this.$emitter.emit('add-flash', {
                                type: 'success',
                                message: @json(trans('measurement::app.messages.unit.saved')),
                            });
