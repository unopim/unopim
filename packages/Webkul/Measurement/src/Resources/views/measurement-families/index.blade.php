<x-admin::layouts>
    <x-slot:title>
        @lang('measurement::app.measurement.index.title')
    </x-slot>

    <x-admin::layouts.page-header :title="trans('measurement::app.measurement.index.title')">
        <x-slot:actions>
                                ...
                                <div class="space-y-3">
                                    <x-admin::form.control-group class="mt-2">
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            v-model="form.code"
                                            rules="required"
                                            :label="trans('measurement::app.measurement.index.code')"
                                    ...
                                    <x-admin::form.control-group class="mt-2">
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            rules="required"
                                            :label="trans('measurement::app.measurement.index.standard')"
                                            :placeholder="trans('measurement::app.measurement.index.enter_standard_unit_code')"
                                        />
                                    ...
                                    <x-admin::form.control-group>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            name="symbol"
                                            v-model="form.symbol"
                                            :placeholder="trans('measurement::app.measurement.index.symbol_example')"
                                        />
                                    </x-admin::form.control-group>
                                </div>
                            </x-slot:content>
