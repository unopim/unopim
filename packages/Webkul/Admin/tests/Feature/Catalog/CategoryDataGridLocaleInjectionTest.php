...
it('preserves a valid locale code in the JSON path', function () {
    ...
    // MySQL renders `$.locale_specific.en_US.name`; PostgreSQL renders
    // `->'locale_specific'->'en_US'->>'name'`. Assert the locale segment is
    // present in either dialect without pinning the JSON-path syntax.
