...
return [
    ...
    'account' => [
        'edit' => [
            ...
            'current-password-info'    => 'Solo se necesita cuando estableces una contraseña nueva. Confirma el cambio con la contraseña de la cuenta con la que iniciaste sesión.',
    ...
    'catalog' => [
        'products' => [
            ...
            'index'          => [
                ...
                'create'                    => [
                    ...
                    'no-variant-structure'              => 'Esta familia no tiene ninguna estructura de variantes. Cree una antes de agregar un producto configurable.',
            ...
            'edit' => [
                ...
                'variations'   => [
                    ...
                    'add-new-btn'    => 'Agregar nuevo',
                    'add-new'        => 'Agregar un nuevo :attribute',
                    'empty'          => 'Aún no hay variantes de :attribute.',
                    'loading'        => 'Cargando...',
        ...
        'categories' => [
            ...
            'browse' => [
                ...
                'tree-view'             => 'Árbol',
                'list-view'             => 'Lista',
                'add-root'              => 'Agregar categoría raíz',
                'add-category'          => 'Agregar categoría',
                'add-child'             => 'Agregar subcategoría',
                'search-placeholder'    => 'Buscar categorías',
                'searching'             => 'Buscando...',
                'no-results'            => 'Ninguna categoría coincide con su búsqueda.',
                'load-more'             => 'Cargar más',
                'loading'               => 'Cargando...',
                ...
                'search-failed'         => 'No se pudieron buscar las categorías.',
                'children-failed'       => 'No se pudieron cargar las subcategorías.',
        ...
        'association_types' => [
            ...
            'not-found'         => 'No se encuentra el Tipo de Asociación con el código ":code"',
            'immutable-fields'  => 'Los siguientes campos no se pueden modificar: :fields.',
            ...
            'fields' => [
                ...
                'create-success'       => 'Campo de Tipo de Asociación Creado Exitosamente',
                'update-success'       => 'Campo de Tipo de Asociación Actualizado Exitosamente',
                'delete-success'       => 'Campo de Tipo de Asociación Eliminado Exitosamente',
                'not-found'            => 'No se pudo encontrar el campo del tipo de asociación con código ":code"',
            ],
        ],
        ...
        'families' => [
            ...
            'edit' => [
                ...
                'parent-product-info'              => 'Valores ingresados una sola vez y heredados por cada variante.',
                ...
                'add-to-level'                     => 'Agregar al nivel :number',
    ...
    'settings' => [
        ...
        'data-transfer' => [
            'tracker' => [
                ...
                'paused-export'         => 'La exportación ha sido pausada.',
                'resumed'               => 'La importación ha sido reanudada.',
                'resumed-export'        => 'La exportación ha sido reanudada.',
                ...
                'cancelled-export'      => 'La exportación ha sido cancelada.',
            ...
            'imports' => [
                ...
                'zip-contents-too-large'     => 'Las imágenes en este ZIP suman más de :limit MB una vez extraídas. Divídelas en archivos más pequeños.',
                'zip-exceeds-server-limit'   => 'Este ZIP es más grande que los :limit KB que este servidor acepta en una sola carga. Aumenta upload_max_filesize y post_max_size en php.ini, o divide el archivo.',
        ...
        'system-settings' => [
            ...
            'microsoft-sso'      => [
                'title' => 'Microsoft SSO',
                'info'  => 'Inicio de sesión único de Microsoft Entra ID para el ingreso de administrador.',
            ],
        ],
        ...
        'roles' => [
            ...
            'create' => [
                ...
                'custom-description' => 'Selecciona permisos individuales del árbol de abajo.',
                'description'        => 'Descripción',
                'general'            => 'General',
                'name'               => 'Nombre',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'microsoft-sso' => [
                    'info'  => 'Configura el inicio de sesión único de Microsoft (Entra ID) para el ingreso de administrador.',
                    'title' => 'Microsoft SSO',

                    'settings' => [
                        'info'                => 'Registra una aplicación en Microsoft Entra ID y pega sus credenciales aquí. Déjalo en blanco para usar los valores del entorno. URI de redirección: /admin/login/sso/microsoft/callback.',
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'max-tokens-info' => 'Límite predeterminado de lo que puede producir una sola generación de IA. La salida HTML gasta tokens en el marcado, así que aumente este valor si el contenido generado se corta a mitad de frase.',
        ...
        'platform' => [
            ...
            'message' => [
                ...
                'extras-reserved-key'                => 'El campo de extras no puede sobrescribir :keys. Use los campos de URL de la API y clave de la API.',
                ...
                'managed-not-configured'             => 'La plataforma de IA administrada no está configurada. Defina MAGIC_AI_MANAGED_MODELS.',
                'managed-provisioned'                => 'La plataforma de IA administrada ":label" está lista.',
                'managed-cannot-delete'              => 'La plataforma administrada no se puede eliminar.',
                'managed-key-prompt'                 => 'Clave de API de la plataforma administrada (déjela vacía para conservar la clave guardada)',
                'managed-key-required'               => 'Se necesita una clave de API para crear la plataforma administrada. Ejecute el comando de forma interactiva e ingrese la clave.',
    ...
    'components' => [
        ...
        'tinymce' => [
            ...
            'ai-generation' => [
                ...
                'max-tokens'             => 'Tokens máximos',
                'temperature'            => 'Temperatura',
                'truncated'              => 'El modelo alcanzó su límite de tokens, así que este contenido puede estar cortado. Aumente el máximo de tokens y genere de nuevo.',
