...
return [
    ...
    'account' => [
        'edit' => [
            ...
            'current-password-info'    => 'Only required when you set a new password. Confirm the change with the password of the account you are signed in with.',
            'email'                    => 'Email',
            'general'                  => 'General',
            ...
            'catalog-locale-info'      => 'The language your catalog content is written in. This is separate from the interface language above.',
    ...
    'catalog' => [
        'products' => [
            ...
            'index'          => [
                ...
                'create'                    => [
                    ...
                    'no-variant-structure'              => 'This family does not have a variant structure. Please create one before adding a configurable product.',
                    'invalid-variant-structure'         => 'The selected variant structure does not belong to this family.',
            ...
            'edit' => [
                ...
                'types' => [
                    'configurable' => [
                        ...
                        'edit' => [
                            'disabled'        => 'Disabled',
                            'edit-info'       => 'If you wish to update product information in detail, then go to the',
                        ...
                        'variant-inheritance' => [
                            'locked'              => 'This attribute can be updated in the :level attributes.',
                            'level-common'        => 'common',
                ...
                'translate' => [
                    ...
                    'next'                        => 'Next',
                    'empty-translation-data'      => 'Data not available for translation based on source channel and locale',
                    'attributes-to-translate'     => 'Attributes to translate',
                    'no-value'                    => 'No value',
                    'change'                      => 'Change',
                    'overwrite-warning'           => 'Existing content in the selected target locales will be replaced.',
                    'incomplete-source'           => 'Select a source channel, a locale and at least one attribute to continue.',
                ],
                'product-info' => [
                    'title'        => 'Product Info',
                    'status'       => 'Status',
                ...
                'variations'   => [
                    ...
                    'complete-count' => ':done of :total complete',
                    'select'         => 'Select :attribute',
                    'add-new-btn'    => 'Add New',
                    'add-new'        => 'Add a new :attribute',
                    'empty'          => 'No :attribute variants yet.',
                    'loading'        => 'Loading...',
                    ...
                    'create'         => 'Create',
                    'creating'       => 'Creating...',
                    'create-error'   => 'Could not create variant',
                ],
            ],
            'bulk-edit' => [
                'validation' => [
        ...
        'attributes' => [
            ...
            'create' => [
                ...
                'code-hint'              => 'Unique technical identifier used in imports, exports and the API. It cannot be changed later.',
                'type-hint'              => 'Defines how values are entered and stored. It cannot be changed later.',
                'is-unique-hint'         => 'Each product must have a unique value for this attribute.',
                'value-per-locale-hint'  => 'Store a different value for each locale (language).',
                'value-per-channel-hint' => 'Store a different value for each sales channel.',
            ...
            'edit' => [
                ...
                'yes'                   => 'Yes',
                'same-code-error'       => 'The option code must be unique.',
                'locked-after-creation' => 'This setting is defined at creation and cannot be changed afterwards.',
                'usable-in-grid'        => 'Usable in grid',
                'is-filterable'         => 'Is filterable',
                'ai-translate'          => 'AI Translate',
                'option'                => [
        ...
        'families' => [
            'index' => [
                ...
                'create'   => [
                    ...
                    'enter-code'    => 'Enter Code',
                    'based-on'      => 'Based On',
                    'select-family' => 'Select a family to copy structure from',
                    'based-on-info' => 'Copies the groups, attributes and variant structure of the selected family. Leave empty to start with a General group containing SKU.',
                ...
                'datagrid' => [
                    ...
                    'partial-action' => 'Some actions were not performed due to restricted system constraints on :resource',
            ...
            'edit' => [
                ...
                'level-variant'                    => 'Variant',
                'common-to-all'                    => 'Common to all variants',
                'axis'                             => 'Axis',
                'drop-here'                        => 'Drop attributes owned here',
                'drag-into-level'                  => 'Drag an attribute into a level.',
                'search-attributes'                => 'Search attributes...',
                'assign-group-to-level'            => 'Assign a whole group to a level:',
                'add-sub-parent'                   => '+ Add sub-parent level',
                'remove-level'                     => 'Remove this level',
                'select-page'                      => 'Select all on page',
                'select-all-matching'              => 'Select all :total attributes',
                'all-selected'                     => 'All :total attributes selected',
                ...
                'parent-sub-parent-child'          => 'Parent → Sub-parent → Child',
                'structure'                        => 'Structure',
                'level-1-axes'                     => 'Level 1 Axes',
                'level-2-axes'                     => 'Level 2 Axes',
                'back-to-variants'                 => 'Back to Variants',
                'variant-setup'                    => 'Variant Setup',
                'edit-variant'                     => 'Edit Variant',
                'delete-variant'                   => 'Delete Variant',
                'parent-product'                   => 'Common',
                'parent-product-info'              => 'Values maintained once and inherited by every variant.',
                'sub-parent-product'               => 'Sub-parent Product',
                'sub-parent-product-info'          => 'Values shared by products inside each level 1 group.',
                'variant-child-product'            => 'Child Product',
                'variant-child-product-info'       => 'Values maintained separately for each final variant.',
                'move-to-parent'                   => 'Move to Common',
                'move-to-sub-parent'               => 'Move to Sub-parent',
                'move-to-child'                    => 'Move to Child',
                'no-parent-attributes'             => 'No common attributes',
                'no-parent-attributes-info'        => 'All matching attributes are assigned to variant levels or used as axes.',
                'no-sub-parent-attributes'         => 'No sub-parent attributes',
                'no-child-attributes'              => 'No child attributes',
                'axis-badge'                       => 'Axis',
                'level-badge'                      => 'Level :number',
                'add-to-level'                     => 'Add to level :number',
                'add-attributes'                   => 'Add attributes',
                'move-to-level-info'               => 'The selected attributes leave Common and are maintained at this level instead.',
                'level-empty-info'                 => 'Only the axis is maintained here so far.',
                'cancel'                           => 'Cancel',
                'axis-locked-info'                 => 'Variant axis. Always maintained at this level and cannot be moved.',
                'drop-or-search-info'              => 'Drop attributes here or adjust the search.',
                'name-code-required'               => 'Name and code are required.',
                'select-axis-warning'              => 'Please select at least one different axis attribute for each level.',
                'unable-save-variant-structure'    => 'Unable to save variant structure.',
                'level-1-attribute'                => 'Level 1 attribute',
                'level-2-attribute'                => 'Level 2 attribute',
                'no-axis-selected'                 => 'No axis selected',
                'variant-name-placeholder'         => 'Example: Colour + Size',
                'variant-code-placeholder'         => 'color_size',
                'attributes-selected'              => 'attributes selected',
                'assign-selected-to'               => 'Assign selected attributes to group',
                'differ-per'                       => 'Different per',
                'differ-sub-help'                  => 'Attributes that change per this level (e.g. a shared image for each colour).',
                'differ-variant-help'              => 'Attributes unique to each variant (e.g. SKU, price, stock).',
                'drop-attributes-here'             => 'Drop attributes here',
                'main-column-info'                 => 'Groups and attributes included in this family.',
                'no-assigned-groups'               => 'No groups assigned',
                'no-assigned-groups-info'          => 'Assign an attribute group to start building this family.',
                'remove-group-btn'                 => 'Remove from Family',
                'search'                           => 'Search',
                'select-destination-group'         => 'Select group',
                'variant-help'                     => 'Define how products in this family split into variants. Drag an attribute onto the level that owns it.',
                'variant-help-easy'                => 'Every attribute is shared across all variants by default. Only drag the ones that are different into a level below.',
                'variant-levels'                   => 'Variant Levels',
                'variants'                         => 'Variants',
                'variant-structure'                => 'Variant Structure',
                'assign-group-btn'                 => 'Assign Attribute Group',
                'assign-group-title'               => 'Assign Attribute Group',
                'back-btn'                         => 'Back',
                'create-group'                     => 'Create this group',
                'code'                             => 'Code',
                'label'                            => 'Label',
                'column'                           => 'Column',
                ...
                'unassigned-attributes-info'       => 'Drag a single attribute onto a group, or tick several and assign them together.',
                'unassigned-attribute-groups'      => 'Unassigned Attribute Groups',
                'assign-first-attribute-group'     => 'Assign the group to the family.',
                'variant-options-label'            => 'Configurable options',
                'select-variant'                   => 'Select attributes',
                'add-variant'                      => 'Add Variant',
                'all-common'                       => 'All attributes are common to every variant.',
                'common-attributes'                => 'Common attributes',
                'common-subtitle'                  => 'Shared by all variants. Drag the ones that differ to a level.',
                'differ-rest-common'               => 'attribute(s) differ · everything else is common.',
                'drop-differ'                      => 'Drag attributes that differ here',
                'family-variants'                  => 'Family Variants',
                'family-variants-info'             => 'Search variants and open one to manage its attributes.',
                'move'                             => 'Move',
                'move-group'                       => 'Move a whole group:',
                'move-to'                          => 'move to',
                'no-unassigned-attributes'         => 'All attributes are assigned',
                'no-unassigned-attributes-info'    => 'Remove a group or attribute from the family to make it available here.',
                'one-level'                        => '1 level · Parent → Variant',
                'save-variant'                     => 'Save Variant',
                'search-assigned'                  => 'Search assigned groups or attributes',
                'shown'                            => 'shown',
                'two-level'                        => '2 levels · Parent → Sub-parent → Variant',
                'variant'                          => 'Variant',
                'variants-info'                    => 'Create and manage how products in this family split into parent, sub-parent, and child variants.',
            ],
            'attribute-family'                => 'Attribute Family',
            ...
            'variant-axis-attribute-required' => 'The attribute(s) ":attributes" cannot be removed because they are used as a variant axis in this family.',
        ],
        'history' => [
    ...
    'settings' => [
        'locales' => [
            'index' => [
                ...
                'create' => [
                    'code'             => 'Code',
                    'code-hint'        => 'Use the ISO locale code, for example en_US or fr_FR.',
                    'code-placeholder' => 'Use ISO code, e.g. en_US',
                    'direction'        => 'Direction',
        ...
        'currencies' => [
            'index' => [
                ...
                'create' => [
                    'code'             => 'Code',
                    'code-hint'        => 'Use the ISO 4217 currency code, for example USD or EUR.',
                    'code-placeholder' => 'Use ISO code, e.g. USD',
                    'create-btn'       => 'Create Currency',
                    'decimal'          => 'Decimal',
                    'delete-warning'   => 'Are you sure you want to perform this action?',
                    'general'          => 'General',
        ...
        'data-transfer' => [
            'tracker' => [
                ...
                'import' => [
                    ...
                    'validate'                => 'Validate',
                    'validating-info'         => 'The data has started reading and validating',
                    'validation-failed-info'  => 'Your import is invalid. Please rectify the following errors and try again.',
                    'validation-success-info' => 'Your import is valid. Click on Export to commence the import process.',
                ],
                'summary' => [
                    'total-batches' => 'Total Batches:',
                    'created'       => 'Total Records Created:',
                ...
                'completed-info-sub'    => 'All records have been processed and indexed. Your catalogue is up to date.',
                ...
                'setup-queue-error'     => 'Please change your queue driver to "database" or "redis" to initiate the import process.',
                'update-success'        => 'Export updated successfully.',
                'failed-info'           => 'Job has failed. Please rectify the following errors and try again.',
                'download-log-file'     => 'Download log',
                'pause'                 => 'Pause',
                'resume'                => 'Resume',
                'cancel'                => 'Cancel',
                'paused'                => 'Import has been paused.',
                'paused-export'         => 'Export has been paused.',
                ...
                'pause-failed'          => 'Failed to pause import.',
                'pause-failed-export'   => 'Failed to pause export.',
                'resume-failed'         => 'Failed to resume import.',
                'resume-failed-export'  => 'Failed to resume export.',
                'cancel-failed'         => 'Failed to cancel import.',
                'cancel-failed-export'  => 'Failed to cancel export.',
                'live'                  => 'Live',
            ...
            'imports' => [
                ...
                'zip-compression-suspicious' => 'The entry ":entry" expands far beyond its compressed size, so the archive was rejected as unsafe.',
                'zip-contents-too-large'     => 'The images in this ZIP add up to more than :limit MB once extracted. Split them across smaller archives.',
                'zip-exceeds-server-limit'   => 'This ZIP is larger than the :limit KB this server accepts in one upload. Raise upload_max_filesize and post_max_size in php.ini, or split the archive.',
                'zip-too-many-entries'       => 'This ZIP holds :count files, and at most :limit can be imported at once. Split it into smaller archives or raise IMAGE_IMPORT_MAX_ENTRIES.',
                'nothing-to-import'          => 'There are no resources to import.',
            ...
            'exports' => [
                'create' => [
                    ...
                    'field-separator'           => 'Field Separator',
                    'file-info-example'         => 'For example, in the case of product-images, files should be placed into /project-root/storage/app/export/product-images folder.',
                    ...
                    'settings'                  => 'Settings',
                    'scope-filters'             => 'Data to export',
                    'product-filters'           => 'Product Filters',
                    'output'                    => 'Output',
                    'format-settings'           => 'Format settings',
                    'custom-attribute-select'   => 'Select attribute',
                    'custom-attribute-value'    => 'Value',
                    'custom-attribute-remove'   => 'Remove',
                    ...
                    'value-number-placeholder'  => 'e.g. 49.99',
                    'range-from'                => 'From',
                    'range-to'                  => 'To',
                    'condition-yes'             => 'Yes',
                    'condition-no'              => 'No',
                ...
                'batch' => [
                    'title' => 'Export added to the queue',
                ],
                'index' => [
        ...
        'users' => [
            'index' => [
                ...
                'title'                          => 'Users',
                'user'                           => 'User',
                'confirm-password-before-delete' => 'Confirm Password Before Delete',
                'enter-current-password'         => 'Enter Current Password',
                'password'                       => 'Password',
                'confirm-delete-account'         => 'Confirm Delete This Account',
                'create'                         => [
                    'confirm-password'    => 'Confirm Password',
                    'email'               => 'Email',
                    'name'                => 'Name',
                    ...
                    'user-timezone'       => 'Timezone',
                    'catalog-locale'      => 'Catalog Locale',
                    'catalog-locale-info' => 'The language this user writes catalog content in. Separate from their interface language.',
                    'default-channel'     => 'Default Channel',
                    'select'              => 'Select',
                ],
                'datagrid' => [
        ...
        'system-settings' => [
            ...
            'microsoft-sso'      => [
                'title' => 'Microsoft SSO',
                'info'  => 'Microsoft Entra ID single sign-on for admin login.',
            ],
        ],
        ...
        'roles' => [
            ...
            'create' => [
                ...
                'all'                => 'All',
                'all-description'    => 'Grant full access to every permission.',
                'back-btn'           => 'Back',
                'custom'             => 'Custom',
                'custom-description' => 'Pick individual permissions from the tree below.',
                'description'        => 'Description',
                'general'            => 'General',
                'name'               => 'Name',
            ...
            'being-used'                      => 'Role is already in use by Admin User',
            'being-used-by'                   => 'Role is already in use by :name User',
            ...
            'last-delete-error'               => 'Last Role cannot be deleted',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'microsoft-sso' => [
                    'info'  => 'Configure Microsoft (Entra ID) single sign-on for admin login.',
                    'title' => 'Microsoft SSO',
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'max-tokens-info' => 'The default ceiling on how much a single AI generation may produce. HTML output spends tokens on markup, so raise this if generated content is cut off mid-sentence.',
                    ...
                    'agentic-pim' => [
                        ...
                        'custom-instructions'       => 'Custom Agent Instructions',
                        'custom-instructions-info'  => 'Extra instructions appended to the AI agent system prompt — use it for company conventions, tone, or catalogue rules the agent must always follow.',
                    ],
                ],
            ],
        ],
        'integrations' => [
            ...
            'edit' => [
                ...
                'credentials-once-note'       => 'These credentials are shown only once. Store them securely — you cannot retrieve the password later.',
                'credentials-info'            => 'Use these credentials to authenticate your integration.',
                'password-forgot-note'        => 'Forgot the password? Regenerate it here — the new password is shown only once.',
                'copy'                        => 'Copy',
            ...
            'being-used'                     => 'API Integration is already in use by Admin User',
            'create-success'                 => 'API Integration Created Successfully',
            'delete-failed'                  => 'API Integration deletion failed',
            'delete-success'                 => 'API Integration deleted successfully',
            'last-delete-error'              => 'The last API Integration cannot be deleted',
            'update-success'                 => 'API Integration updated successfully',
            'generate-key-success'           => 'API key generated successfully',
            're-generate-secret-key-success' => 'API secret key regenerated successfully',
        ...
        'system-prompt' => [
            ...
            'create' => [
                ...
                'max-tokens-info'     => 'Allowed max output token range: 100 to 5000 tokens.',
                'temperature-info'    => 'Temperature controls creativity. Range: 0 to 2. Lower values (e.g., 0.4) give more accurate and focused responses.',
        ...
        'platform' => [
            ...
            'errors' => [
                'no-models-returned' => 'No models returned. Add models manually below.',
                'fetch-failed'       => 'Failed to fetch. You can add models manually below.',
            ...
            'command' => [
                'target'             => 'Which platform do you want to set up?',
                'target-new'         => 'Create a new platform',
            ...
            'message' => [
                ...
                'unsafe-api-url'                     => 'The API URL points to a restricted or invalid address and cannot be used.',
                'extras-reserved-key'                => 'The extras field cannot override :keys. Use the API URL and API key fields instead.',
                'extras-invalid-json'                => 'The extras field must contain a valid JSON object.',
                'extras-too-large'                   => 'The extras field is too large.',
                'custom-provider-error'              => 'Custom Provider Error',
                'ai-response-timeout'                => 'The AI response is taking longer than expected. Please try again.',
                'no-model-configured'                => 'No model is configured for the selected platform.',
                'no-platform-configured'             => 'No AI platform is configured. Please add a platform in Configuration > Magic AI > Platforms.',
                'images-unsupported'                 => 'The provider :provider does not support image generation. Use OpenAI, Gemini or xAI.',
    ...
    'components' => [
        ...
        'form' => [
            ...
            'unsaved-changes' => [
                ...
                'save'            => 'Save changes',
                'saving'          => 'Saving…',
                'save-failed'     => 'Your changes were not saved. Please review the highlighted fields.',
                'field-badge'     => 'Unsaved',
        ...
        'datagrid' => [
            ...
            'toolbar' => [
                ...
                'select-all-matching' => 'Select all :total',
                'all-selected'        => 'All matching records selected',
                'clear-selection'     => 'Clear selection',
        ...
        'tinymce' => [
            ...
            'ai-generation' => [
                ...
                'max-tokens'             => 'Max Tokens',
                'temperature'            => 'Temperature',
                'truncated'              => 'The model reached its token limit, so this content may be cut off. Raise Max Tokens and generate again.',
    ...
    'errors' => [
        ...
        '503' => [
            'description' => 'Oops! Looks like we\'re temporarily down for maintenance. Please check back shortly.',
    ...
    'validations' => [
        'slug-being-used' => 'This slug is being used in either categories or products.',
    ...
    'default-prompt' => [
        ...
        'overview' => [
            ...
            'prompt' => 'Create a detailed overview of @name, highlighting its key features, advantages, and target audience like @brand and @colour.',
        ],
        'features' => [
