        ...
        'attributes' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'delete-attribute-failure' => 'Bu özellik, yapılandırılabilir ürünlerde kullanıldığından kaldırılamaz', ],
                'columns' => [
                    'code'       => 'Kod',
                    'label'      => 'Etiket',
                    'type'       => 'Tür',
            ...
            'edit' => [
                ...
                'multiselect'           => 'Çoklu Seçim',
                'no'                    => 'Hayır',
                'no-columns'            => 'Hiç sütun eklenmedi. Lütfen bir tane ekleyin.',
                'number'                => 'Numara',
                'options'               => 'Seçenekler',
                'position'              => 'Pozisyon',
                'price'                 => 'Fiyat',
                ...
                'table-attribute' => [
                    'save'                => 'Kaydet',
                    'save-success'        => 'Başarıyla kaydedildi',
                    'save-failed'         => 'Kaydedilemedi',
                ],
            ],

            'column' => [
                'not-found'           => '":code" koduna sahip sütun bulunamadı',
                'no-options-provided' => 'Hiçbir seçenek sağlanmadı',
                'code-required'       => 'Öznitelik kodu ve sütun kodu gereklidir',
                'option'              => [
            ...
            'invalid-column-type' => "Seçenekler yalnızca 'select' veya 'multiselect' türündeki sütunlar için oluşturulabilir.",
        ],
