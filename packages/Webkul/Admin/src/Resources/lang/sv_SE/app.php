    ...
    'catalog' => [
        ...
        'attributes' => [
            ...
            'edit' => [
                ...
                'multiselect'           => 'Multivälj',
                'no'                    => 'Nej',
                'no-columns'            => 'Inga kolumner har lagts till. Vänligen lägg till en.',
                'number'                => 'Nummer',
                'options'               => 'Alternativ',
                'position'              => 'Position',
                'price'                 => 'Pris',
                ...
                'table-attribute' => [
                    'save'                => 'Spara',
                    'save-success'        => 'Sparat framgångsrikt',
                    'save-failed'         => 'Misslyckades med att spara',
                ],
            ],

            'column' => [
                'not-found'           => 'Kolumn med kod ":code" hittades inte',
                'no-options-provided' => 'Inga alternativ har angetts',
                'code-required'       => 'Attributkod och kolumnkod krävs',
                'option'              => [
            ...
            'invalid-column-type' => "Alternativ kan endast skapas för kolumner av typen 'select' eller 'multiselect'.",
        ],
