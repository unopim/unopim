    ...
    'catalog' => [
        ...
        'attributes' => [
            ...
            'edit' => [
                ...
                'multiselect'           => 'Višestruki odabir',
                'no'                    => 'Ne',
                'no-columns'            => 'Nijedan stupac nije dodan. Molimo dodajte jedan.',
                'number'                => 'Broj',
                'options'               => 'Opcije',
                'position'              => 'Pozicija',
                'price'                 => 'Cijena',
                ...
                'table-attribute' => [
                    'save'                => 'Spremi',
                    'save-success'        => 'Uspješno spremljeno',
                    'save-failed'         => 'Spremanje nije uspjelo',
                ],
            ],

            'column' => [
                'not-found'           => 'Stupac s kodom ":code" nije pronađen',
                'no-options-provided' => 'Nisu pružene opcije',
                'code-required'       => 'Potrebni su kod atributa i kod stupca',
                'option'              => [
            ...
            'invalid-column-type' => "Opcije se mogu kreirati samo za stupce tipa 'select' ili 'multiselect'.",
        ],
