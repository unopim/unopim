...
return [
    ...
    'account' => [
        'edit' => [
            ...
            'current-password-info'    => 'Potrebna samo kada postavljate novu lozinku. Potvrdite promjenu lozinkom računa s kojim ste prijavljeni.',
            'email'                    => 'E-pošta',
            'general'                  => 'Opće',
    ...
    'catalog' => [
        'products' => [
            ...
            'index'          => [
                ...
                'datagrid' => [
                    ...
                    'id-value'                => 'ID - :id',
                    'image'                   => 'Slika',
                    'mass-delete-queued'      => 'Odabrani proizvodi brišu se u pozadini',
            ...
            'edit' => [
                ...
                'translate' => [
                    ...
                    'attributes-to-translate'     => 'Atributi za prijevod',
                    'no-value'                    => 'Nema vrijednosti',
                    'change'                      => 'Promijeni',
                    'overwrite-warning'           => 'Postojeći sadržaj na odabranim ciljnim jezicima bit će zamijenjen.',
                    'incomplete-source'           => 'Odaberite izvorni kanal, jezik i barem jedan atribut za nastavak.',
                ],
                'product-info' => [
            ...
            'variant-structure-not-found'     => 'Struktura varijanti s oznakom ":code" nije pronađena u obitelji ":family"',
            'variant-structure-axis-mismatch' => 'Navedeni super atributi ne odgovaraju osima strukture varijanti ":code". Očekivano: :axes',
        ],
        'attributes' => [
            'index' => [
        ...
        'categories' => [
            ...
            'browse' => [
                ...
                'searching'             => 'Pretraživanje...',
                'no-results'            => 'Nijedna kategorija ne odgovara pretrazi.',
        ...
        'families' => [
            ...
            'variant-axis-attribute-required' => 'Atribut ":attributes" nije moguće ukloniti jer se koristi kao os varijante u ovoj obitelji.',
        ],
        'history' => [
    ...
    'settings' => [
        ...
        'data-transfer' => [
            'tracker' => [
                ...
                'paused-export'         => 'Izvoz je pauziran.',
                ...
                'pause-failed-export'   => 'Pauziranje izvoza nije uspjelo.',
                'resume-failed'         => 'Nastavak uvoza nije uspio.',
                'resume-failed-export'  => 'Nastavak izvoza nije uspio.',
                'cancel-failed'         => 'Otkazivanje uvoza nije uspjelo.',
                'cancel-failed-export'  => 'Otkazivanje izvoza nije uspjelo.',
                'live'                  => 'Uživo',
            ...
            'imports' => [
                ...
                'zip-compression-suspicious' => 'Unos ":entry" znatno se proširuje izvan svoje komprimirane veličine, pa je arhiva odbijena kao nesigurna.',
                'zip-contents-too-large'     => 'Slike u ovom ZIP-u nakon raspakiravanja zauzimaju više od :limit MB. Podijelite ih u manje arhive.',
                'zip-exceeds-server-limit'   => 'Ovaj ZIP je veći od :limit KB koje ovaj poslužitelj prihvaća u jednom prijenosu. Povećajte upload_max_filesize i post_max_size u php.ini ili podijelite arhivu.',
                'zip-too-many-entries'       => 'Ovaj ZIP sadrži :count datoteka, a odjednom se može uvesti najviše :limit. Podijelite ga u manje arhive ili povećajte IMAGE_IMPORT_MAX_ENTRIES.',
                'nothing-to-import'          => 'Nema resursa za uvoz.',
    ...
    'configuration' => [
            ...
            'general' => [
                ...
                'microsoft-sso' => [
                    ...
                    'settings' => [
                        ...
                        'redirect-uri'        => 'URI preusmjeravanja',
                        'redirect-uri-info'   => 'Registrirajte točno ovaj URL u registraciji aplikacije Microsoft Entra ID pod Autentifikacija → URI-ji preusmjeravanja, koristeći Web platformu.',
                        'redirect-uri-copy'   => 'Kopiraj',
                        'redirect-uri-copied' => 'Kopirano u međuspremnik',
                    ],
                ],
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'max-tokens'      => 'Najveći broj izlaznih tokena',
                        'max-tokens-info' => 'Zadano ograničenje koliko jedno AI generiranje smije proizvesti. HTML izlaz troši tokene na oznake, pa povećajte vrijednost ako se generirani sadržaj prekida usred rečenice.',
                        'title'           => 'Opće postavke',
        ...
        'platform' => [
            ...
            'message' => [
                ...
                'extras-reserved-key'                => 'Polje dodataka ne može nadjačati :keys. Umjesto toga upotrijebite polja URL-a API-ja i API ključa.',
                'extras-invalid-json'                => 'Polje dodataka mora sadržavati valjani JSON objekt.',
                'extras-too-large'                   => 'Polje dodataka je preveliko.',
                ...
                'managed-not-configured'             => 'Upravljana AI platforma nije konfigurirana. Postavite MAGIC_AI_MANAGED_MODELS.',
                'managed-provisioned'                => 'Upravljana AI platforma ":label" je spremna.',
                'managed-cannot-delete'              => 'Upravljana platforma ne može se izbrisati.',
                'managed-key-prompt'                 => 'API ključ upravljane platforme (ostavite prazno da biste zadržali spremljeni ključ)',
                'managed-key-required'               => 'Za stvaranje upravljane platforme potreban je API ključ. Pokrenite naredbu interaktivno i unesite ključ.',
    ...
    'components' => [
        ...
        'tinymce' => [
            ...
            'ai-generation' => [
                ...
                'max-tokens'             => 'Maks. tokeni',
                'temperature'            => 'Temperatura',
                'truncated'              => 'Model je dosegnuo ograničenje tokena pa je sadržaj možda odrezan. Povećajte najveći broj tokena i generirajte ponovno.',
    ...
    'help' => [
        ...
        'system-info' => [
            ...
            'subtitle' => 'Izvršno okruženje, konfiguracija poslužitelja i instalirani paketi za ovu UnoPim instancu.',
            'enabled'  => 'Omogućeno',
            'disabled' => 'Onemogućeno',
            'package'  => 'Paket',

            'search-packages' => 'Pretraži pakete...',
            'no-packages'     => 'Nijedan paket ne odgovara vašem pretraživanju.',
            'sections'        => [
                ...
                'packages'    => 'Instalirani paketi',
            ],
            'fields' => [
                'unopim_version'        => 'Verzija UnoPima',
                'laravel_version'       => 'Verzija Laravela',
                ...
                'url'                   => 'URL aplikacije',
                'operating_system'      => 'Operacijski sustav',
                'server_software'       => 'Poslužiteljski softver',
                'php_sapi'              => 'PHP SAPI',
                'memory_limit'          => 'Ograničenje memorije',
                'max_execution_time'    => 'Najdulje vrijeme izvršavanja',
                'upload_max_filesize'   => 'Najveća veličina datoteke za prijenos',
                'post_max_size'         => 'Najveća veličina POST zahtjeva',
                'connection'            => 'Veza',
                'driver'                => 'Upravljački program',
                'version'               => 'Verzija',
                'cache_driver'          => 'Upravljački program predmemorije',
                'queue_connection'      => 'Veza s redom čekanja',
                'session_driver'        => 'Upravljački program sesije',
                'mail_mailer'           => 'Usluga e-pošte',
