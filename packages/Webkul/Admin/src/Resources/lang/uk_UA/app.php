    ...
    'catalog' => [
        ...
        'families' => [
            ...
            'edit' => [
                ...
                'parent-product'                   => 'Батьківський продукт',
                'parent-product-info'              => 'Значення задаються один раз і успадковуються дочірніми продуктами.',
                ...
                'move-to-parent'                   => 'Перемістити до батьківського',
                'move-to-sub-parent'               => 'Перемістити до підбатьківського',
                'move-to-child'                    => 'Перемістити до дочірнього',
                'no-parent-attributes'             => 'Немає батьківських атрибутів',
