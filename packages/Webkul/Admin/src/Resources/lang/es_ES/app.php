    ...
    'configuration' => [
        ...
        'platform' => [
            ...
            'message' => [
                ...
                'managed-not-configured'             => 'La plataforma de IA gestionada no está configurada. Defina MAGIC_AI_MANAGED_MODELS.',
                'managed-provisioned'                => 'La plataforma de IA gestionada ":label" está lista.',
                'managed-cannot-delete'              => 'La plataforma gestionada no se puede eliminar.',
                'managed-key-prompt'                 => 'Clave de API de la plataforma gestionada (déjela vacía para conservar la clave guardada)',
                'managed-key-required'               => 'Se necesita una clave de API para crear la plataforma gestionada. Ejecute el comando de forma interactiva e introduzca la clave.',
