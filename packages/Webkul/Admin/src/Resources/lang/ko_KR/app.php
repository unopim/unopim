        ...
        'attributes' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'delete-attribute-failure' => '이 속성은 구성 가능한 제품에 사용되므로 제거할 수 없습니다',
                ],
                'columns' => [
                    'code'       => '코드',
                    'label'      => '라벨',
            ...
            'edit' => [
                ...
                'multiselect'           => '다중 선택',
                'no'                    => '아니오',
                'no-columns'            => '열이 추가되지 않았습니다. 하나 추가해 주세요.',
                'number'                => '숫자',
                'options'               => '옵션',
                'position'              => '위치',
                'price'                 => '가격',
            ...
            'column' => [
                'not-found'           => '코드 ":code" 열을 찾을 수 없습니다',
                'no-options-provided' => '옵션이 제공되지 않았습니다',
                'code-required'       => '속성 코드와 열 코드가 필요합니다',
                'option'              => [
            ...
            'invalid-column-type' => "옵션은 'select' 또는 'multiselect' 타입의 열에서만 생성할 수 있습니다.",
        ],
