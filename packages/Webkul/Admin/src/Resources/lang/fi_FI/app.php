        ...
        'attributes' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'delete-attribute-failure' => 'Tätä attribuuttia ei voida poistaa, koska sitä käytetään konfiguroitavissa tuotteissa',
                ],
                'columns' => [
                    'code'       => 'Koodi',
                    'label'      => 'Nimiö',
            ...
            'edit' => [
                ...
                'multiselect'           => 'Monivalinta',
                'no'                    => 'Ei',
                'no-columns'            => 'Sarakkeita ei ole lisätty. Lisää yksi.',
                'number'                => 'Numero',
                'options'               => 'Vaihtoehdot',
                'position'              => 'Sijainti',
                'price'                 => 'Hinta',
                ...
                'table-attribute' => [
                    'save'                => 'Tallenna',
                    'save-success'        => 'Tallennettu onnistuneesti',
                    'save-failed'         => 'Tallennus epäonnistui',
                ],
            ],

            'column' => [
                'not-found'           => 'Saraketta koodilla ":code" ei löytynyt',
                'no-options-provided' => 'Vaihtoehtoja ei ole annettu',
                'code-required'       => 'Attribuuttikoodi ja sarakekoodi vaaditaan',
                'option'              => [
            ...
            'invalid-column-type' => 'Vaihtoehtoja voidaan luoda vain select- tai multiselect-tyyppisille sarakkeille.',
        ],
