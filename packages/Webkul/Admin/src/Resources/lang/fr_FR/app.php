    ...
    'catalog' => [
        ...
        'attributes' => [
            ...
            'edit' => [
                ...
                'multiselect'           => 'Sélection multiple',
                'no'                    => 'Non',
                'no-columns'            => 'Aucune colonne ajoutée. Veuillez en ajouter une.',
                'number'                => 'Nombre',
                'options'               => 'Options',
                'position'              => 'Position',
                'price'                 => 'Prix',
                ...
                'column' => [
                    'title'               => 'Colonne',
                    'save-btn'            => 'Enregistrer la colonne',
            ...
            'column' => [
                'not-found'           => 'Colonne avec le code ":code" introuvable',
                'no-options-provided' => 'Aucune option n\'a été fournie',
                'code-required'       => 'Le code de l\'attribut et le code de la colonne sont requis',
                'option'              => [
            ...
            'invalid-column-type' => "Les options ne peuvent être créées que pour des colonnes de type 'select' ou 'multiselect'.",
        ],
