        ...
        'attributes' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'delete-attribute-failure' => 'Denne attribut kan ikke fjernes, da den bruges til konfigurerbare produkter',
                ],
                'columns' => [
                    'code'       => 'Kode',
                    'label'      => 'Etiket',
            ...
            'edit' => [
                ...
                'multiselect'           => 'Multiselect',
                'no'                    => 'Nej',
                'no-columns'            => 'Ingen kolonner tilføjet. Tilføj venligst en.',
                'number'                => 'Nummer',
                'options'               => 'Muligheder',
                'position'              => 'Position',
                'price'                 => 'Pris',
                ...
                'table-attribute' => [
                    'save'                => 'Gem',
                    'save-success'        => 'Gemt med succes',
                    'save-failed'         => 'Kunne ikke gemme',
                ],
            ],

            'column' => [
                'not-found'           => 'Kolonnen med koden ":code" blev ikke fundet',
                'no-options-provided' => 'Ingen valgmuligheder er angivet',
                'code-required'       => 'Attributkode og kolonne-kode er påkrævet',
                'option'              => [
            ...
            'invalid-column-type' => 'Valgmuligheder kan kun oprettes for kolonner af typen select eller multiselect.',
        ],
