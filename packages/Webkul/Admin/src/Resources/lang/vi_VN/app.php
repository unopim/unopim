        ...
        'attributes' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'delete-attribute-failure' => 'Không thể xóa thuộc tính này vì nó đang được sử dụng cho sản phẩm có thể cấu hình', ],
                'columns' => [
                    'code'       => 'Mã',
                    'label'      => 'Nhãn',
                    'type'       => 'Loại',
            ...
            'edit' => [
                ...
                'multiselect'           => 'Chọn nhiều',
                'no'                    => 'Không',
                'no-columns'            => 'Chưa thêm cột nào. Vui lòng thêm một cột.',
                'number'                => 'Số',
                'options'               => 'Tùy chọn',
                'position'              => 'Vị trí',
                'price'                 => 'Giá',
            ...
            'column' => [
                'not-found'           => 'Không tìm thấy cột với mã ":code"',
                'no-options-provided' => 'Không có tùy chọn nào được cung cấp',
                'code-required'       => 'Yêu cầu mã thuộc tính và mã cột',
                'option'              => [
            ...
            'invalid-column-type' => "Các tùy chọn chỉ có thể được tạo cho các cột có kiểu 'select' hoặc 'multiselect'.",
        ],
