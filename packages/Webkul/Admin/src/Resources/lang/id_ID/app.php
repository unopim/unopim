...
return [
    ...
    'account' => [
        'edit' => [
            ...
            'current-password-info'    => 'Hanya diperlukan saat Anda menetapkan kata sandi baru. Konfirmasi perubahan dengan kata sandi akun yang sedang Anda gunakan.',
            'email'                    => 'Surel',
            'general'                  => 'Umum',
    ...
    'catalog' => [
        'products' => [
            ...
            'index'          => [
                ...
                'datagrid' => [
                    ...
                    'image'                   => 'Gambar',
                    'mass-delete-queued'      => 'Produk yang dipilih sedang dihapus di latar belakang',
            ...
            'edit' => [
                ...
                'types' => [
                    'configurable' => [
                        ...
                        'variant-inheritance' => [
                            'locked'              => 'Atribut ini dapat diperbarui di atribut :level.',
                            'level-common'        => 'umum',
                            'level-sub_parent'    => 'sub-induk',
                ...
                'translate' => [
                    ...
                    'attributes-to-translate'     => 'Atribut yang akan diterjemahkan',
                    'no-value'                    => 'Tidak ada nilai',
                    'change'                      => 'Ubah',
                    'overwrite-warning'           => 'Konten yang ada pada bahasa tujuan terpilih akan diganti.',
                    'incomplete-source'           => 'Pilih saluran sumber, bahasa, dan minimal satu atribut untuk melanjutkan.',
                ],
                'product-info' => [
                ...
                'variations'   => [
                    ...
                    'complete-count' => ':done dari :total lengkap',
                    'select'         => 'Pilih :attribute',
                    'add-new-btn'    => 'Tambah Baru',
                    'add-new'        => 'Tambahkan :attribute baru',
                    'empty'          => 'Belum ada varian :attribute.',
                    'loading'        => 'Memuat...',
                    ...
                    'create'         => 'Buat',
                    'creating'       => 'Membuat...',
                    'create-error'   => 'Tidak dapat membuat varian',
                ],
            ],
            'bulk-edit' => [
                'validation' => [
            ...
            'variant-structure-not-found'     => 'Struktur varian dengan kode ":code" tidak ditemukan pada famili ":family"',
            'variant-structure-axis-mismatch' => 'Atribut super yang diberikan tidak cocok dengan sumbu struktur varian ":code". Diharapkan: :axes',
        ],
        'attributes' => [
            'index' => [
        ...
        'categories' => [
            ...
            'browse' => [
                ...
                'searching'             => 'Mencari...',
                'no-results'            => 'Tidak ada kategori yang cocok dengan pencarian Anda.',
        ...
        'families' => [
            ...
            'edit' => [
                ...
                'parent-product'                   => 'Umum',
                'parent-product-info'              => 'Nilai dikelola sekali dan diwarisi oleh setiap varian.',
                ...
                'move-to-parent'                   => 'Pindahkan ke Umum',
                'move-to-sub-parent'               => 'Pindahkan ke Sub-induk',
                'move-to-child'                    => 'Pindahkan ke Anak',
                'no-parent-attributes'             => 'Tidak ada atribut umum',
                ...
                'add-to-level'                     => 'Tambahkan ke Level :number',
                'add-attributes'                   => 'Tambahkan atribut',
                'move-to-level-info'               => 'Atribut yang dipilih keluar dari Umum dan dikelola pada level ini.',
                'level-empty-info'                 => 'Sejauh ini hanya sumbu yang dikelola di sini.',
                'cancel'                           => 'Batalkan',
                'axis-locked-info'                 => 'Sumbu varian. Selalu dikelola pada level ini dan tidak dapat dipindahkan.',
            ...
            'variant-axis-attribute-required' => 'Atribut ":attributes" tidak dapat dihapus karena digunakan sebagai sumbu varian pada famili ini.',
        ],
        'history' => [
    ...
    'settings' => [
        ...
        'data-transfer' => [
            'tracker' => [
                ...
                'paused-export'         => 'Ekspor telah dijeda.',
                ...
                'pause-failed-export'   => 'Gagal menjeda ekspor.',
                'resume-failed'         => 'Gagal melanjutkan impor.',
                'resume-failed-export'  => 'Gagal melanjutkan ekspor.',
                'cancel-failed'         => 'Gagal membatalkan impor.',
                'cancel-failed-export'  => 'Gagal membatalkan ekspor.',
                'live'                  => 'Langsung',
            ...
            'imports' => [
                ...
                'zip-compression-suspicious' => 'Entri ":entry" mengembang jauh melebihi ukuran terkompresinya, sehingga arsip ditolak karena dianggap tidak aman.',
                'zip-contents-too-large'     => 'Gambar dalam ZIP ini berjumlah lebih dari :limit MB setelah diekstrak. Bagi menjadi beberapa arsip yang lebih kecil.',
                'zip-exceeds-server-limit'   => 'ZIP ini lebih besar dari :limit KB yang diterima server ini dalam satu unggahan. Tingkatkan upload_max_filesize dan post_max_size di php.ini, atau bagi arsip tersebut.',
                'zip-too-many-entries'       => 'ZIP ini berisi :count file, sedangkan paling banyak :limit yang dapat diimpor sekaligus. Bagi menjadi arsip yang lebih kecil atau tingkatkan IMAGE_IMPORT_MAX_ENTRIES.',
                'nothing-to-import'          => 'Tidak ada sumber daya untuk diimpor.',
                'setup-queue-error'          => 'Harap ubah driver antrian Anda menjadi "basis data" atau "redis" untuk memulai proses impor.',
        ...
        'users' => [
            ...
            'cannot-assign-unheld-permissions' => 'Anda tidak dapat menetapkan peran yang memiliki izin yang tidak Anda miliki.',
    ...
    'configuration' => [
            ...
            'general' => [
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'max-tokens'      => 'Token Keluaran Maksimum',
                        'max-tokens-info' => 'Batas bawaan untuk seberapa banyak yang boleh dihasilkan satu kali pembuatan AI. Keluaran HTML menghabiskan token untuk markup, jadi naikkan nilai ini jika konten yang dihasilkan terpotong di tengah kalimat.',
        ...
        'platform' => [
            ...
            'message' => [
                ...
                'extras-reserved-key'                => 'Kolom ekstra tidak dapat menimpa :keys. Gunakan kolom URL API dan kunci API sebagai gantinya.',
                'extras-invalid-json'                => 'Kolom ekstra harus berisi objek JSON yang valid.',
                'extras-too-large'                   => 'Kolom ekstra terlalu besar.',
                ...
                'managed-not-configured'             => 'Platform AI terkelola belum dikonfigurasi. Atur MAGIC_AI_MANAGED_MODELS.',
                'managed-provisioned'                => 'Platform AI terkelola ":label" sudah siap.',
                'managed-cannot-delete'              => 'Platform terkelola tidak dapat dihapus.',
                'managed-key-prompt'                 => 'Kunci API untuk platform terkelola (kosongkan untuk mempertahankan kunci yang tersimpan)',
                'managed-key-required'               => 'Kunci API diperlukan untuk membuat platform terkelola. Jalankan perintah secara interaktif lalu masukkan kuncinya.',
    ...
    'components' => [
        ...
        'form' => [
            ...
            'unsaved-changes' => [
                ...
                'saving'          => 'Menyimpan…',
                'save-failed'     => 'Perubahan Anda tidak disimpan. Harap tinjau bidang yang disorot.',
        ...
        'datagrid' => [
            ...
            'filters' => [
                ...
                'saved-filters'   => [
                    ...
                    'none'         => 'Belum ada filter tersimpan',
                    'unsaved'      => 'Perubahan belum disimpan',
                    'clear'        => 'Hapus semua filter',
                    'name'         => 'Nama filter',
                    'share'        => 'Bagikan ke semua admin',
                    'save'         => 'Simpan filter',
                    'saved'        => 'Filter disimpan',
                    'deleted'      => 'Filter dihapus',
                    'shared'       => 'Dibagikan',
                    'delete'       => 'Hapus filter',
                ],
                'dropdown'        => [
        ...
        'tinymce' => [
            ...
            'ai-generation' => [
                ...
                'max-tokens'             => 'Token Maksimum',
                'temperature'            => 'Suhu',
                'truncated'              => 'Model mencapai batas tokennya, sehingga konten ini mungkin terpotong. Naikkan Token Maksimum lalu buat ulang.',
    ...
    'help' => [
        ...
        'system-info' => [
            ...
            'subtitle' => 'Lingkungan runtime, konfigurasi server, dan paket terpasang untuk instans UnoPim ini.',
            'enabled'  => 'Diaktifkan',
            ...
            'sections'        => [
                ...
                'packages'    => 'Paket Terpasang',
            ],
            'fields' => [
                'unopim_version'        => 'Versi UnoPim',
                ...
                'upload_max_filesize'   => 'Ukuran Maksimum File Unggahan',
                'post_max_size'         => 'Ukuran Maksimum POST',
                'connection'            => 'Koneksi',
                'driver'                => 'Driver',
                'version'               => 'Versi',
