...
return [
    ...
    'account' => [
        'edit' => [
            ...
            'current-password-info'    => 'Alleen vereist wanneer u een nieuw wachtwoord instelt. Bevestig de wijziging met het wachtwoord van het account waarmee u bent aangemeld.',
            'email'                    => 'E-mailadres',
            'general'                  => 'Algemeen',
    ...
    'catalog' => [
        'products' => [
            ...
            'index'          => [
                ...
                'datagrid' => [
                    ...
                    'id-value'                => 'ID: :id',
                    'image'                   => 'Afbeelding',
                    'mass-delete-queued'      => 'Geselecteerde producten worden op de achtergrond verwijderd',
            ...
            'edit' => [
                ...
                'translate' => [
                    ...
                    'attributes-to-translate'     => 'Te vertalen kenmerken',
                    'no-value'                    => 'Geen waarde',
                    'change'                      => 'Wijzigen',
                    'overwrite-warning'           => 'Bestaande inhoud in de geselecteerde doeltalen wordt vervangen.',
                    'incomplete-source'           => 'Selecteer een bronkanaal, een taal en minstens één kenmerk om door te gaan.',
                ],
                'product-info' => [
            ...
            'variant-structure-not-found'     => 'Variantstructuur met code ":code" is niet gevonden in familie ":family"',
            'variant-structure-axis-mismatch' => 'De opgegeven superattributen komen niet overeen met de assen van variantstructuur ":code". Verwacht: :axes',
        ],
        'attributes' => [
            'index' => [
        ...
        'categories' => [
            ...
            'browse' => [
                ...
                'searching'             => 'Bezig met zoeken...',
                'no-results'            => 'Geen categorieën komen overeen met je zoekopdracht.',
                'load-more'             => 'Meer laden',
        ...
        'families' => [
            ...
            'variant-axis-attribute-required' => 'Het attribuut ":attributes" kan niet worden verwijderd omdat het als variantas in deze familie wordt gebruikt.',
        ],
        'history' => [
    ...
    'settings' => [
        ...
        'data-transfer' => [
            'tracker' => [
                ...
                'paused-export'         => 'De export is gepauzeerd.',
                ...
                'pause-failed-export'   => 'Kan de export niet pauzeren.',
                'resume-failed'         => 'Kan de import niet hervatten.',
                'resume-failed-export'  => 'Kan de export niet hervatten.',
                'cancel-failed'         => 'Kan de import niet annuleren.',
                'cancel-failed-export'  => 'Kan de export niet annuleren.',
                'live'                  => 'Live',
            ...
            'imports' => [
                ...
                'zip-compression-suspicious' => 'Het item ":entry" wordt bij het uitpakken veel groter dan zijn gecomprimeerde grootte, waardoor het archief als onveilig is geweigerd.',
                'zip-contents-too-large'     => 'De afbeeldingen in dit ZIP-bestand zijn na uitpakken samen groter dan :limit MB. Verdeel ze over kleinere archieven.',
                'zip-exceeds-server-limit'   => 'Dit ZIP-bestand is groter dan de :limit KB die deze server per upload accepteert. Verhoog upload_max_filesize en post_max_size in php.ini, of splits het archief.',
                'zip-too-many-entries'       => 'Dit ZIP-bestand bevat :count bestanden, terwijl er maximaal :limit tegelijk kunnen worden geïmporteerd. Splits het in kleinere archieven of verhoog IMAGE_IMPORT_MAX_ENTRIES.',
                'nothing-to-import'          => 'Er is niets om te importeren.',
                'setup-queue-error'          => 'Wijzig je wachtrijdriver naar "database" of "redis" om het importproces te starten.',
    ...
    'configuration' => [
            ...
            'general' => [
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'max-tokens'      => 'Maximum aantal uitvoertokens',
                        'max-tokens-info' => 'De standaardlimiet voor hoeveel één AI-generatie mag produceren. HTML-uitvoer besteedt tokens aan opmaak, dus verhoog deze waarde als gegenereerde inhoud midden in een zin afbreekt.',
        ...
        'platform' => [
            ...
            'message' => [
                ...
                'extras-reserved-key'                => 'Het veld extra\'s kan :keys niet overschrijven. Gebruik in plaats daarvan de velden API-URL en API-sleutel.',
                'extras-invalid-json'                => 'Het veld extra\'s moet een geldig JSON-object bevatten.',
                'extras-too-large'                   => 'Het veld extra\'s is te groot.',
                ...
                'managed-not-configured'             => 'Het beheerde AI-platform is niet geconfigureerd. Stel MAGIC_AI_MANAGED_MODELS in.',
                'managed-provisioned'                => 'Het beheerde AI-platform ":label" is klaar.',
                'managed-cannot-delete'              => 'Het beheerde platform kan niet worden verwijderd.',
                'managed-key-prompt'                 => 'API-sleutel voor het beheerde platform (laat leeg om de opgeslagen sleutel te behouden)',
                'managed-key-required'               => 'Er is een API-sleutel nodig om het beheerde platform aan te maken. Voer de opdracht interactief uit en voer de sleutel in.',
    ...
    'components' => [
        ...
        'tinymce' => [
            ...
            'ai-generation' => [
                ...
                'max-tokens'             => 'Max tokens',
                'temperature'            => 'Temperatuur',
                'truncated'              => 'Het model heeft zijn tokenlimiet bereikt, dus deze inhoud kan afgekapt zijn. Verhoog het maximale aantal tokens en genereer opnieuw.',
    ...
    'help' => [
        ...
        'system-info' => [
            ...
            'subtitle' => 'Runtimeomgeving, serverconfiguratie en geïnstalleerde pakketten voor deze UnoPim-instantie.',
            'enabled'  => 'Ingeschakeld',
            'disabled' => 'Uitgeschakeld',
            'package'  => 'Pakket',
            ...
            'sections'        => [
                ...
                'packages'    => 'Geïnstalleerde pakketten',
            ],
            'fields' => [
                'unopim_version'        => 'UnoPim-versie',
                ...
                'version'               => 'Versie',
                'cache_driver'          => 'Cachestuurprogramma',
                'queue_connection'      => 'Wachtrijverbinding',
                'session_driver'        => 'Sessiestuurprogramma',
                'mail_mailer'           => 'E-mailservice',
