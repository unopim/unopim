    ...
    'catalog' => [
        ...
        'attributes' => [
            ...
            'edit' => [
                ...
                'multiselect'           => '複数選択',
                'no'                    => 'いいえ',
                'no-columns'            => '列が追加されていません。追加してください。',
                'number'                => '番号',
                'options'               => 'オプション',
                'position'              => '位置',
                'price'                 => '価格',
                ...
                'table-attribute' => [
                    'save'                => '保存',
                    'save-success'        => '正常に保存されました',
                    'save-failed'         => '保存に失敗しました',
                ],
            ],

            'column' => [
                'not-found'           => 'コード ":code" の列が見つかりません',
                'no-options-provided' => 'オプションが提供されていません',
                'code-required'       => '属性コードと列コードが必要です',
                'option'              => [
            ...
            'invalid-column-type' => "オプションは 'select' または 'multiselect' タイプのカラムでのみ作成できます。",
        ],
