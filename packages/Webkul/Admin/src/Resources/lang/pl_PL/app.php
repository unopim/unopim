        ...
        'attributes' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'delete-attribute-failure' => 'Ten atrybut nie może zostać usunięty, ponieważ jest używany w produktach konfigurowalnych', ],
                'columns' => [
                    'code'       => 'Kod',
                    'label'      => 'Etykieta',
                    'type'       => 'Typ',
            ...
            'edit' => [
                ...
                'multiselect'           => 'Wielokrotny wybór',
                'no'                    => 'Nie',
                'no-columns'            => 'Nie dodano kolumn. Proszę dodać jedną.',
                'number'                => 'Numer',
                'options'               => 'Opcje',
                'position'              => 'Pozycja',
                'price'                 => 'Cena',
            ...
            'column' => [
                'not-found'           => 'Nie znaleziono kolumny o kodzie ":code"',
                'no-options-provided' => 'Nie podano żadnych opcji',
                'code-required'       => 'Wymagany jest kod atrybutu i kod kolumny',
                'option'              => [
            ...
            'invalid-column-type' => "Opcje można tworzyć tylko dla kolumn typu 'select' lub 'multiselect'.",
        ],
