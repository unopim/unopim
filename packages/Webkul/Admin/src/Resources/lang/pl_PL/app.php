...
return [
    ...
    'account' => [
        'edit' => [
            ...
            'current-password-info'    => 'Wymagane tylko przy ustawianiu nowego hasła. Potwierdź zmianę hasłem konta, na które jesteś zalogowany.',
            'email'                    => 'E-mail',
            'general'                  => 'Ogólne',
            ...
            'upload-image-info'        => 'Prześlij zdjęcie profilowe (110px X 110px) lub użyj obrazu Gravatar.com powiązanego z Twoim adresem e-mail.',
            'user-timezone'            => 'Strefa czasowa',
            'catalog-locale'           => 'Język katalogu',
            'catalog-locale-info'      => 'Język, w którym napisana jest treść Twojego katalogu. Jest on niezależny od powyższego języka interfejsu.',
    ...
    'catalog' => [
        'products' => [
            ...
            'index'          => [
                ...
                'create'                    => [
                    ...
                    'type'                              => 'Typ',
                    'variant-structure'                 => 'Struktura wariantów',
                    'not-config-family-error'           => 'Ta rodzina nie ma konfigurowalnych atrybutów',
                    'no-variant-structure'              => 'Ta rodzina nie ma struktury wariantów. Utwórz ją przed dodaniem produktu konfigurowalnego.',
                    'invalid-variant-structure'         => 'Wybrana struktura wariantów nie należy do tej rodziny.',
                ...
                'datagrid' => [
                    ...
                    'id-value'                => 'ID - :id',
                    'image'                   => 'Obraz',
                    'mass-delete-queued'      => 'Wybrane produkty są usuwane w tle',
            ...
            'edit' => [
                ...
                'types' => [
                    'configurable' => [
                        ...
                        'variant-inheritance' => [
                            'locked'              => 'Ten atrybut można zaktualizować w atrybutach :level.',
                            'level-common'        => 'wspólnych',
                            'level-sub_parent'    => 'podrzędnych',
                            'level-variant'       => 'wariantu',
                        ],
                    ],
                ],
                'translate' => [
                    ...
                    'attributes-to-translate'     => 'Atrybuty do przetłumaczenia',
                    'no-value'                    => 'Brak wartości',
                    'change'                      => 'Zmień',
                    'overwrite-warning'           => 'Istniejąca treść w wybranych językach docelowych zostanie zastąpiona.',
                    'incomplete-source'           => 'Wybierz kanał źródłowy, język i co najmniej jeden atrybut, aby kontynuować.',
                ],
                'product-info' => [
                ...
                'variations'   => [
                    ...
                    'variant-count'  => ':count wariant',
                    'variants-count' => ':count wariantów',
                    'complete-count' => ':done z :total ukończonych',
                    'select'         => 'Wybierz :attribute',
                    'add-new-btn'    => 'Dodaj nowy',
                    'add-new'        => 'Dodaj nowy :attribute',
                    'empty'          => 'Brak wariantów :attribute.',
                    'loading'        => 'Ładowanie...',
                    'loading-more'   => 'Ładowanie kolejnych...',
                    'sku'            => 'SKU',
                    'cancel'         => 'Anuluj',
                    'create'         => 'Utwórz',
                    'creating'       => 'Tworzenie...',
                    'create-error'   => 'Nie udało się utworzyć wariantu',
                ],
            ],
            'bulk-edit' => [
                'validation' => [
            ...
            'immutable-fields'                => 'Następujących pól nie można modyfikować: :fields.',
            'variant-structure-not-found'     => 'Nie znaleziono struktury wariantów o kodzie ":code" w rodzinie ":family"',
            'variant-structure-axis-mismatch' => 'Podane superatrybuty nie odpowiadają osiom struktury wariantów ":code". Oczekiwano: :axes',
        ],
        'attributes' => [
            'index' => [
                ...
                'datagrid'   => [
                    ...
                    'mass-delete-partial'      => 'Nie można usunąć :count atrybutu(ów), ponieważ są używane w produktach konfigurowalnych.',
            ...
            'create' => [
                ...
                'code-hint'              => 'Unikalny identyfikator techniczny używany w imporcie, eksporcie i API. Nie można go później zmienić.',
                'type-hint'              => 'Określa sposób wprowadzania i przechowywania wartości. Nie można go później zmienić.',
                'is-unique-hint'         => 'Każdy produkt musi mieć unikalną wartość tego atrybutu.',
                'value-per-locale-hint'  => 'Przechowuj inną wartość dla każdego języka.',
                'value-per-channel-hint' => 'Przechowuj inną wartość dla każdego kanału sprzedaży.',
            ...
            'edit' => [
                ...
                'yes'                   => 'Tak',
                'same-code-error'       => 'Kod opcji musi być unikalny.',
                'locked-after-creation' => 'To ustawienie jest określane podczas tworzenia i nie można go później zmienić.',
                'usable-in-grid'        => 'Można używać w siatce',
                'is-filterable'         => 'Jest filtrowalne',
                'ai-translate'          => 'Tłumaczenie SI',
                'option'                => [
        ...
        'categories' => [
            ...
            'browse' => [
                'categories-count'      => ':count kategorii',
                'trees'                 => 'Drzewa',
                'channel-root'          => 'Korzeń kanału',
                'subcategories-count'   => ':count podkategorii',
                'tree-view'             => 'Drzewo',
                'list-view'             => 'Lista',
                ...
                'searching'             => 'Wyszukiwanie...',
                'no-results'            => 'Żadna kategoria nie pasuje do wyszukiwania.',
            ...
            'upload-failure'       => 'Nie można przesłać pliku kategorii.',
        ...
        'families' => [
            'index' => [
                ...
                'create'   => [
                    ...
                    'select-family' => 'Wybierz rodzinę, z której skopiować strukturę',
                    'based-on-info' => 'Kopiuje grupy, atrybuty i strukturę wariantów wybranej rodziny. Pozostaw puste, aby zacząć od grupy Ogólne zawierającej SKU.',
            ...
            'edit' => [
                ...
                'common-to-all'                    => 'Wspólne dla wszystkich wariantów',
                'axis'                             => 'Oś',
                'drop-here'                        => 'Upuść tutaj atrybuty należące do tego poziomu',
                'drag-into-level'                  => 'Przeciągnij atrybut do poziomu.',
                'search-attributes'                => 'Szukaj atrybutów...',
                'assign-group-to-level'            => 'Przypisz całą grupę do poziomu:',
                'add-sub-parent'                   => '+ Dodaj poziom podnadrzędny',
                'remove-level'                     => 'Usuń ten poziom',
                'select-page'                      => 'Zaznacz wszystko na stronie',
                'select-all-matching'              => 'Zaznacz wszystkie :total atrybutów',
                'all-selected'                     => 'Zaznaczono wszystkie :total atrybutów',
                ...
                'structure'                        => 'Struktura',
                'level-1-axes'                     => 'Osie poziomu 1',
                'level-2-axes'                     => 'Osie poziomu 2',
                'back-to-variants'                 => 'Powrót do wariantów',
                'variant-setup'                    => 'Konfiguracja wariantów',
                'edit-variant'                     => 'Edytuj wariant',
                'delete-variant'                   => 'Usuń wariant',
                'parent-product'                   => 'Wspólne',
                'parent-product-info'              => 'Wartości utrzymywane raz i dziedziczone przez każdy wariant.',
                'sub-parent-product'               => 'Produkt podnadrzędny',
                'sub-parent-product-info'          => 'Wartości współdzielone przez produkty w każdej grupie poziomu 1.',
                'variant-child-product'            => 'Produkt podrzędny',
                'variant-child-product-info'       => 'Wartości utrzymywane osobno dla każdego końcowego wariantu.',
                'move-to-parent'                   => 'Przenieś do Wspólnych',
                'move-to-sub-parent'               => 'Przenieś do podnadrzędnego',
                'move-to-child'                    => 'Przenieś do podrzędnego',
                'no-parent-attributes'             => 'Brak atrybutów wspólnych',
                'no-parent-attributes-info'        => 'Wszystkie pasujące atrybuty są przypisane do poziomów wariantów lub używane jako osie.',
                'no-sub-parent-attributes'         => 'Brak atrybutów podnadrzędnych',
                'no-child-attributes'              => 'Brak atrybutów podrzędnych',
                'axis-badge'                       => 'Oś',
                'level-badge'                      => 'Poziom :number',
                'add-to-level'                     => 'Dodaj do poziomu :number',
                'add-attributes'                   => 'Dodaj atrybuty',
                'move-to-level-info'               => 'Wybrane atrybuty opuszczają Wspólne i są utrzymywane na tym poziomie.',
                'level-empty-info'                 => 'Na razie utrzymywana jest tutaj tylko oś.',
                'cancel'                           => 'Anuluj',
                'axis-locked-info'                 => 'Oś wariantu. Zawsze utrzymywana na tym poziomie i nie można jej przenieść.',
                'drop-or-search-info'              => 'Upuść tutaj atrybuty lub zmień wyszukiwanie.',
                'name-code-required'               => 'Nazwa i kod są wymagane.',
                'select-axis-warning'              => 'Wybierz co najmniej jeden inny atrybut osi dla każdego poziomu.',
                'unable-save-variant-structure'    => 'Nie można zapisać struktury wariantów.',
                'level-1-attribute'                => 'Atrybut poziomu 1',
                'level-2-attribute'                => 'Atrybut poziomu 2',
                'no-axis-selected'                 => 'Nie wybrano osi',
                'variant-name-placeholder'         => 'Przykład: Kolor + Rozmiar',
                'variant-code-placeholder'         => 'color_size',
                'attributes-selected'              => 'wybranych atrybutów',
                'assign-selected-to'               => 'Przypisz wybrane atrybuty do grupy',
                'differ-per'                       => 'Różne dla',
                'differ-sub-help'                  => 'Atrybuty zmieniające się na tym poziomie (np. wspólny obraz dla każdego koloru).',
                'differ-variant-help'              => 'Atrybuty unikalne dla każdego wariantu (np. SKU, cena, stan magazynowy).',
                'drop-attributes-here'             => 'Upuść atrybuty tutaj',
                'main-column-info'                 => 'Grupy i atrybuty należące do tej rodziny.',
                'no-assigned-groups'               => 'Nie przypisano grup',
                'no-assigned-groups-info'          => 'Przypisz grupę atrybutów, aby rozpocząć budowanie tej rodziny.',
                'remove-group-btn'                 => 'Usuń z rodziny',
                'search'                           => 'Szukaj',
                'select-destination-group'         => 'Wybierz grupę',
                'variant-help'                     => 'Określ, jak produkty w tej rodzinie dzielą się na warianty. Przeciągnij atrybut na poziom, do którego należy.',
                'variant-help-easy'                => 'Domyślnie każdy atrybut jest współdzielony przez wszystkie warianty. Przeciągnij na niższy poziom tylko te, które się różnią.',
                'variant-levels'                   => 'Poziomy wariantów',
                'variants'                         => 'Warianty',
                'variant-structure'                => 'Struktura wariantów',
                'assign-group-btn'                 => 'Przypisz grupę atrybutów',
                'assign-group-title'               => 'Przypisz grupę atrybutów',
                'back-btn'                         => 'Wróć',
                'create-group'                     => 'Utwórz tę grupę',
                'code'                             => 'Kod',
                'label'                            => 'Etykieta',
                'column'                           => 'Kolumna',
                ...
                'unassigned-attributes-info'       => 'Przeciągnij pojedynczy atrybut na grupę albo zaznacz kilka i przypisz je razem.',
                ...
                'all-common'                       => 'Wszystkie atrybuty są wspólne dla każdego wariantu.',
                'common-attributes'                => 'Atrybuty wspólne',
                'common-subtitle'                  => 'Współdzielone przez wszystkie warianty. Przeciągnij różniące się na poziom.',
                'differ-rest-common'               => 'atrybut(y) się różnią · cała reszta jest wspólna.',
                'drop-differ'                      => 'Przeciągnij tutaj różniące się atrybuty',
                'family-variants'                  => 'Warianty rodziny',
                'family-variants-info'             => 'Wyszukaj warianty i otwórz jeden, aby zarządzać jego atrybutami.',
                'move'                             => 'Przenieś',
                'move-group'                       => 'Przenieś całą grupę:',
                'move-to'                          => 'przenieś do',
                'no-unassigned-attributes'         => 'Wszystkie atrybuty są przypisane',
                'no-unassigned-attributes-info'    => 'Usuń grupę lub atrybut z rodziny, aby był dostępny tutaj.',
                'one-level'                        => '1 poziom · Nadrzędny → Wariant',
                'save-variant'                     => 'Zapisz wariant',
                'search-assigned'                  => 'Szukaj przypisanych grup lub atrybutów',
                'shown'                            => 'pokazano',
                'two-level'                        => '2 poziomy · Nadrzędny → Podrzędny nadrzędny → Wariant',
                'variant'                          => 'Wariant',
                'variants-info'                    => 'Twórz i zarządzaj podziałem produktów tej rodziny na warianty nadrzędne, podrzędne nadrzędne i podrzędne.',
            ],
            'attribute-family'                => 'Rodzina atrybutów',
            ...
            'variant-axis-attribute-required' => 'Atrybutu ":attributes" nie można usunąć, ponieważ jest używany jako oś wariantu w tej rodzinie.',
        ],
        'history' => [
    ...
    'settings' => [
        'locales' => [
            'index' => [
                ...
                'create' => [
                    'code'             => 'Kod',
                    'code-hint'        => 'Użyj kodu ustawień regionalnych ISO, na przykład en_US lub fr_FR.',
                    'code-placeholder' => 'Użyj kodu ISO, np. en_US',
                    'direction'        => 'Kierunek',
        ...
        'currencies' => [
            'index' => [
                ...
                'create' => [
                    'code'             => 'Kod',
                    'code-hint'        => 'Użyj kodu waluty ISO 4217, na przykład USD lub EUR.',
                    'code-placeholder' => 'Użyj kodu ISO, np. USD',
                    'create-btn'       => 'Utwórz Walutę',
                    'decimal'          => 'Dziesiętny',
                    'delete-warning'   => 'Czy na pewno chcesz wykonać tę akcję?',
                    'general'          => 'Ogólne',
        ...
        'data-transfer' => [
            'tracker' => [
                ...
                'paused-export'         => 'Eksport został wstrzymany.',
                ...
                'pause-failed'          => 'Nie udało się wstrzymać importu.',
                'pause-failed-export'   => 'Nie udało się wstrzymać eksportu.',
                'resume-failed'         => 'Nie udało się wznowić importu.',
                'resume-failed-export'  => 'Nie udało się wznowić eksportu.',
                'cancel-failed'         => 'Nie udało się anulować importu.',
                'cancel-failed-export'  => 'Nie udało się anulować eksportu.',
                'live'                  => 'Na żywo',
            ...
            'imports' => [
                ...
                'zip-compression-suspicious' => 'Wpis ":entry" rozszerza się znacznie ponad swój skompresowany rozmiar, dlatego archiwum zostało odrzucone jako niebezpieczne.',
                'zip-contents-too-large'     => 'Obrazy w tym pliku ZIP po rozpakowaniu zajmują łącznie ponad :limit MB. Podziel je na mniejsze archiwa.',
                'zip-exceeds-server-limit'   => 'Ten plik ZIP jest większy niż :limit KB akceptowane przez ten serwer w jednym przesłaniu. Zwiększ wartości upload_max_filesize i post_max_size w php.ini lub podziel archiwum.',
                'zip-too-many-entries'       => 'Ten plik ZIP zawiera :count plików, a jednorazowo można zaimportować maksymalnie :limit. Podziel go na mniejsze archiwa lub zwiększ IMAGE_IMPORT_MAX_ENTRIES.',
                'nothing-to-import'          => 'Nie ma zasobów do zaimportowania.',
            ...
            'exports' => [
                'create' => [
                    ...
                    'settings'                  => 'Ustawienia',
                    'scope-filters'             => 'Dane do eksportu',
                    'product-filters'           => 'Filtry produktów',
                    'output'                    => 'Wynik',
                    'format-settings'           => 'Ustawienia formatu',
                    'custom-attribute-select'   => 'Wybierz atrybut',
                    'custom-attribute-value'    => 'Wartość',
                    'custom-attribute-remove'   => 'Usuń',
                    ...
                    'value-number-placeholder'  => 'np. 49.99',
                    'range-from'                => 'Od',
                    'range-to'                  => 'Do',
                    'condition-yes'             => 'Tak',
                    'condition-no'              => 'Nie',
                    'operators'                 => [
                        ...
                        'not_in'             => 'Poza listą',
                        'empty'              => 'Jest pusty',
                        'not_empty'          => 'Nie jest pusty',
                        'contains'           => 'Zawiera',
                        'equals'             => 'Równe',
                        'less_than'          => 'Mniejsze niż',
                        'less_than_equal'    => 'Mniejsze lub równe',
                        'greater_than'       => 'Większe niż',
                        'greater_than_equal' => 'Większe lub równe',
                        'between'            => 'Pomiędzy',
                        'before'             => 'Przed',
                        'after'              => 'Po',
                    ],
        ...
        'users' => [
            'index' => [
                ...
                'confirm-password-before-delete' => 'Potwierdź hasło przed usunięciem',
                'enter-current-password'         => 'Wprowadź bieżące hasło',
                'password'                       => 'Hasło',
                'confirm-delete-account'         => 'Potwierdź usunięcie tego konta',
                'create'                         => [
                    'confirm-password'    => 'Potwierdź hasło',
                    'email'               => 'E-mail',
                    'name'                => 'Imię',
                    ...
                    'user-timezone'       => 'Strefa czasowa',
                    'catalog-locale'      => 'Język katalogu',
                    'catalog-locale-info' => 'Język, w którym ten użytkownik pisze treść katalogu. Niezależny od jego języka interfejsu.',
                    'default-channel'     => 'Domyślny kanał',
                    'select'              => 'Wybierz',
                ],
                'datagrid' => [
            ...
            'cannot-assign-unheld-permissions' => 'Nie możesz przypisać roli, która zawiera uprawnienia, których nie masz.',
            ...
            'last-all-access-delete-error'     => 'Nie można usunąć ostatniego aktywnego administratora z pełnym dostępem.',
        ],
        'system-settings' => [
            ...
            'microsoft-sso'      => [
                'title' => 'Microsoft SSO',
                'info'  => 'Logowanie jednokrotne Microsoft Entra ID dla logowania administratora.',
            ],
        ],
        ...
        'roles' => [
            ...
            'create' => [
                ...
                'all'                => 'Wszystkie',
                'all-description'    => 'Przyznaj pełny dostęp do wszystkich uprawnień.',
                'back-btn'           => 'Wróć',
                'custom'             => 'Niestandardowy',
                'custom-description' => 'Wybierz pojedyncze uprawnienia z drzewa poniżej.',
                'description'        => 'Opis',
                'general'            => 'Ogólny',
                'name'               => 'Nazwa',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'microsoft-sso' => [
                    'info'  => 'Skonfiguruj logowanie jednokrotne Microsoft (Entra ID) dla logowania administratora.',
                    'title' => 'Microsoft SSO',
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'max-tokens'      => 'Maksymalna liczba tokenów wyjściowych',
                        'max-tokens-info' => 'Domyślny limit tego, ile może wytworzyć pojedyncze generowanie AI. Wyjście HTML zużywa tokeny na znaczniki, więc zwiększ tę wartość, jeśli wygenerowana treść urywa się w połowie zdania.',
                    ...
                    'agentic-pim' => [
                        ...
                        'custom-instructions'       => 'Niestandardowe instrukcje agenta',
                        'custom-instructions-info'  => 'Dodatkowe instrukcje dołączane do promptu systemowego agenta AI — użyj ich do konwencji firmowych, tonu lub reguł katalogu, których agent musi zawsze przestrzegać.',
                    ],
                ],
            ],
        ],
        'integrations' => [
            ...
            'edit' => [
                ...
                'credentials-once-note'       => 'Te dane uwierzytelniające są wyświetlane tylko raz. Przechowuj je w bezpiecznym miejscu — hasła nie będzie można później odzyskać.',
                'credentials-info'            => 'Użyj tych danych uwierzytelniających, aby uwierzytelnić swoją integrację.',
                'password-forgot-note'        => 'Zapomniałeś hasła? Wygeneruj je ponownie tutaj — nowe hasło zostanie wyświetlone tylko raz.',
                'copy'                        => 'Kopiuj',
        ...
        'system-prompt' => [
            ...
            'create' => [
                ...
                'max-tokens-info'     => 'Dozwolony zakres maksymalnej liczby tokenów wyjściowych: od 100 do 5000 tokenów.',
                'temperature-info'    => 'Temperatura kontroluje kreatywność. Zakres: od 0 do 2. Niższe wartości (np. 0,4) dają dokładniejsze i bardziej skoncentrowane odpowiedzi.',
        ...
        'platform' => [
            ...
            'errors' => [
                'no-models-returned' => 'Nie zwrócono żadnych modeli. Dodaj modele ręcznie poniżej.',
                'fetch-failed'       => 'Nie udało się pobrać. Możesz dodać modele ręcznie poniżej.',
            ...
            'message' => [
                ...
                'unsafe-api-url'                     => 'API URL wskazuje na ograniczony lub nieprawidłowy adres i nie może zostać użyty.',
                'extras-reserved-key'                => 'Pole dodatków nie może nadpisać :keys. Zamiast tego użyj pól adresu URL API i klucza API.',
                'extras-invalid-json'                => 'Pole dodatków musi zawierać prawidłowy obiekt JSON.',
                'extras-too-large'                   => 'Pole dodatków jest za duże.',
                'custom-provider-error'              => 'Błąd dostawcy niestandardowego',
                'ai-response-timeout'                => 'Odpowiedź AI trwa dłużej niż oczekiwano. Spróbuj ponownie.',
                'no-model-configured'                => 'Nie skonfigurowano modelu dla wybranej platformy.',
                'no-platform-configured'             => 'Nie skonfigurowano platformy AI. Dodaj platformę w Konfiguracja > Magic AI > Platformy.',
                'images-unsupported'                 => 'Dostawca :provider nie obsługuje generowania obrazów. Użyj OpenAI, Gemini lub xAI.',
                ...
                'managed-not-configured'             => 'Zarządzana platforma AI nie jest skonfigurowana. Ustaw MAGIC_AI_MANAGED_MODELS.',
                'managed-provisioned'                => 'Zarządzana platforma AI ":label" jest gotowa.',
                'managed-cannot-delete'              => 'Zarządzanej platformy nie można usunąć.',
                'managed-key-prompt'                 => 'Klucz API zarządzanej platformy (pozostaw puste, aby zachować zapisany klucz)',
                'managed-key-required'               => 'Do utworzenia zarządzanej platformy wymagany jest klucz API. Uruchom polecenie w trybie interaktywnym i wprowadź klucz.',
    ...
    'components' => [
        ...
        'form' => [
            ...
            'file-uploader'   => [
                ...
                'upload-hint' => 'lub przeciągnij i upuść',
            ],
            'unsaved-changes' => [
                'title'           => 'Masz niezapisane zmiany',
                'sections'        => 'Zmodyfikowano :count sekcji',
                'fields'          => 'Zmodyfikowano :count pól',
                'section'         => 'Zmodyfikowano :count sekcję',
                'field'           => 'Zmodyfikowano :count pole',
                'discard'         => 'Odrzuć',
                'save'            => 'Zapisz zmiany',
                'saving'          => 'Zapisywanie…',
                'save-failed'     => 'Twoje zmiany nie zostały zapisane. Sprawdź wyróżnione pola.',
                'field-badge'     => 'Niezapisane',
                'leave-message'   => 'Opuścić tę stronę? Niezapisane zmiany zostaną utracone.',
                'stay'            => 'Zostań na stronie',
                'leave'           => 'Opuść',
                'discard-title'   => 'Odrzucić zmiany?',
                'discard-message' => 'Spowoduje to cofnięcie wszystkich niezapisanych zmian w tym formularzu.',
                'cancel'          => 'Anuluj',
            ],
        ],
        'layouts' => [
        ...
        'datagrid' => [
            'index' => [
                ...
                'copy-failed'                      => 'Kopiowanie nie powiodło się. Skopiuj link ręcznie.',
            ],
            'toolbar' => [
                'length-of'           => ':length z',
                'of'                  => 'z',
                ...
                'select-all-matching' => 'Zaznacz wszystkie :total',
                'all-selected'        => 'Zaznaczono wszystkie pasujące rekordy',
                'clear-selection'     => 'Wyczyść wybór',
                'selection-options'   => 'Opcje zaznaczania',
                'mass-actions'        => [
                    'submit'        => 'Zatwierdź',
            ...
            'filters' => [
                ...
                'saved-filters'   => [
                    ...
                    'none'         => 'Brak zapisanych filtrów',
                    'unsaved'      => 'Niezapisane zmiany',
                    'clear'        => 'Wyczyść wszystkie filtry',
                    'name'         => 'Nazwa filtra',
                    'share'        => 'Udostępnij wszystkim administratorom',
                    'save'         => 'Zapisz filtr',
                    'saved'        => 'Filtr zapisany',
                    'deleted'      => 'Filtr usunięty',
                    'shared'       => 'Udostępniony',
                    'delete'       => 'Usuń filtr',
                ],
                'dropdown'        => [
        ...
        'products' => [
            'search' => [
                'search-by-sku' => 'Szukaj według SKU',
        ...
        'media' => [
            'images' => [
                ...
                'drag-drop-hint'     => 'Przeciągnij i upuść lub kliknij, aby przesłać',
            ...
            'files' => [
                ...
                'preview-unavailable' => 'Podgląd jest niedostępny dla tego typu pliku.',
            ],
        ],
        'tinymce' => [
            ...
            'ai-generation' => [
                ...
                'max-tokens'             => 'Maks. tokeny',
                'temperature'            => 'Temperatura',
                'truncated'              => 'Model osiągnął limit tokenów, więc treść może być ucięta. Zwiększ maksymalną liczbę tokenów i wygeneruj ponownie.',
    ...
    'help' => [
        ...
        'system-info' => [
            ...
            'subtitle' => 'Środowisko uruchomieniowe, konfiguracja serwera i zainstalowane pakiety tej instancji UnoPim.',
            'enabled'  => 'Włączone',
            'disabled' => 'Wyłączone',
            'package'  => 'Pakiet',

            'search-packages' => 'Szukaj pakietów...',
            'no-packages'     => 'Żaden pakiet nie pasuje do wyszukiwania.',
            'sections'        => [
