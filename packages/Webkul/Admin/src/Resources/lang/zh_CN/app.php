...
return [
    ...
    'catalog' => [
        ...
        'attributes' => [
            ...
            'column' => [
                'not-found'           => '未找到代码为“:code”的列',
                'no-options-provided' => '未提供任何选项',
                'code-required'       => '需要属性代码和列代码',
                'option'              => [
            ...
            'invalid-column-type' => "选项只能为类型为 'select' 或 'multiselect' 的列创建。",
        ],
