<x-admin::layouts>
    ...
    <div class="flex justify-between items-center mb-7">
        <p class="py-3 text-xl text-gray-800 dark:text-slate-50 font-bold">
            @lang('admin::app.configuration.index.title')
        </p>
    ...
    <div class="grid gap-y-8">
        @foreach ($config->items as $itemKey => $item)
            <div>
                ...
                <div class="grid grid-cols-4 gap-12 flex-wrap justify-between p-4 mt-2 bg-white dark:bg-cherry-900 rounded box-shadow max-1580:grid-cols-3 max-xl:grid-cols-2 max-sm:grid-cols-1">
                    <!-- Menus cards -->
                        ...
                        >
                            @if (isset($child['icon']))
                                <img
                                    ...
                                    src="{{ unopim_asset('images/' . $child['icon'] ?? '') }}"
                                >
                            @endif
