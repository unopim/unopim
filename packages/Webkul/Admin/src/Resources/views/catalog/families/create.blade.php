<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.catalog.families.store')">
        ...
        {!! view_render_event('unopim.admin.catalog.families.create.create_form_controls.after') !!}
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2.5 justify-between mb-2.5 p-4">
                    ...
                    <div class="flex gap-x-1 items-center">
                        ...
                        >
                            @lang('admin::app.catalog.families.create.assign-group-btn')
                        </div>
                    </div>
                </div>
                    ...
                    <div class="">
                        ...
                        <div class="flex flex-col mb-4" v-if="defaultFamilyGroups.length === 0">
                            <p class="ext-xs font-medium text-gray-500 dark:text-gray-300">
                                @lang('admin::app.catalog.families.create.assign-first-attribute-group')
                            </p>
                        </div>
                        ...
                        <x-admin::modal ref="assignGroupModal">
                            ...
                            <x-slot:header>
                                <p class="text-lg text-gray-800 dark:text-white font-bold">
                                    @lang('admin::app.catalog.families.create.assign-group-title')
                                </p>
                            </x-slot>
            ...
            app.component('v-family-attributes', {
                ...
                computed: {
                    ...
                    unassignedAttributeGroups() {
                        if (!this.familyDefaultGroups) {
                            return JSON.stringify(this.customAttributeGroups);
                        }
