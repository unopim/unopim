...
>
    ...
    @isset($header)
        <template v-slot:header="{ close }">
            <div {{ $header->attributes->merge(['class' => 'grid gap-y-2.5 p-3 border-b dark:border-cherry-800 max-sm:px-4']) }}>
                {{ $header }}
...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <div
                    class="fixed inset-0 bg-gray-500 bg-opacity-30 transition-opacity z-[10001]"
                    v-show="isOpen"
                ></div>
            </transition>
            ...
            >
                <div
                    ...
                    v-if="isOpen"
                >
                    <div class="w-full h-full overflow-auto bg-white dark:bg-cherry-800 pointer-events-auto">
