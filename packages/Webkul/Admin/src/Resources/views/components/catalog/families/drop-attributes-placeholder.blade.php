<div {{ $attributes->merge(['class' => 'relative my-1 ltr:pl-5 rtl:pr-5']) }}>
    ...
    <div class="flex min-h-10 items-center justify-center gap-2 rounded-md border border-dashed border-gray-300 bg-gray-50 px-3 py-2 text-xs font-medium text-gray-500 transition-all dark:border-gray-600 dark:bg-cherry-800 dark:text-gray-300">
