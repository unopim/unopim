...
>
    @if ($icon)
        <span class="flex items-center justify-center w-11 h-11 rounded-xl bg-primary-50 dark:bg-cherry-900 shrink-0 transition-all duration-150 group-hover:bg-primary-600">
