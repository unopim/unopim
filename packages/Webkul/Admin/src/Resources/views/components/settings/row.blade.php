...
>
    @if ($icon)
        <span class="flex items-center justify-center w-11 h-11 rounded-xl bg-violet-50 dark:bg-cherry-900 text-violet-600 dark:text-violet-300 shrink-0 transition-all duration-150 group-hover:bg-violet-600 group-hover:text-white">
