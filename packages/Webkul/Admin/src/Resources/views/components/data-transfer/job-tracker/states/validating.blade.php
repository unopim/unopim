                ...
                >
                    {!! view_render_event('unopim.admin.settings.data_transfer.tracker.job.state.validating.before', $jobTrack) !!}
                    ...
                    {!! view_render_event('unopim.admin.settings.data_transfer.tracker.job.state.validating.after', $jobTrack) !!}
                </div>
