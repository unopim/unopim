...
@if (! $isMultiRow)
    <div class="row grid grid-cols-6 gap-2.5 items-center px-4 py-2.5 border-b dark:border-gray-800">
        ...
        <div class="shimmer w-[100px] h-[17px] justify-end"></div>
    </div>
@else
    <div class="row grid grid-cols-[2fr_1fr_1fr] gap-2.5 items-center px-4 py-2.5 border-b dark:border-cherry-800 tems-center">
        <!-- Mass Actions -->
