...
@pushOnce('scripts')
<script type="text/x-template" id="v-fullscreen-modal-template">
    <div>
            <div @click="toggle">
                <slot name="toggle">
                </slot>
            ...
            >
                ...
                >
                    <div class="flex min-h-full items-end justify-center p-4 sm:items-center sm:p-0">
                        <div class="w-auto max-w-screen-lg max-h-[96%] overflow-y-auto z-[999] absolute ltr:left-1/2 rtl:right-1/2 top-1/2 rounded-lg bg-white dark:bg-gray-900 box-shadow max-md:w-[90%] ltr:-translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2">
                            <!-- Header Slot -->
                            <slot
                                name="header"
                                :toggle="toggle"
...
<script type="module">
    app.component('v-fullscreen-modal', {
        template: '#v-fullscreen-modal-template',
