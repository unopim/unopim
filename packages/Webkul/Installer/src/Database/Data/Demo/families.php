    ...
    'families' => [
        ...
        [
            ...
            'groups' => [
                ...
                'price'            => $pricing,
                'media'            => $media,
                'technical'        => ['material', 'features', 'capacity', 'care_instructions', 'power_output', 'battery_life_hours'],
                'marketing'        => $promo,
                'logistics'        => $shipping,
                'sustainability'   => $green,
            ],
        ...
        [
            ...
            'groups' => [
                ...
                'technical'        => ['material', 'finish', 'seat_height', 'power_output', 'features', 'care_instructions', 'max_user_weight'],
                'marketing'        => [...$promo, 'room'],
                'logistics'        => [...$shipping, 'assembly_required'],
                'sustainability'   => $green,
            ],
