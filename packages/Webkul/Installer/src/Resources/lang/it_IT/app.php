...
return [
    ...
    'upgrade' => [
        ...
        'step-failed'           => 'Il passaggio :command non è riuscito con codice di uscita :code.',
        'phase'                 => [
        ...
        'reindex'               => [
            ...
            'too-large' => '--with-reindex ignorato: :count prodotto/i supera il limite di :limit prodotti per una ricostruzione immediata.',
    ...
    'installer' => [
        'index' => [
            ...
            'environment-configuration' => [
                ...
                'app-key-missing'     => 'Nessun file .env è stato trovato e APP_KEY non è impostato nell\'ambiente del server. Il programma di installazione non scrive mai la configurazione dell\'ambiente — crea un .env a mano (copia .env.example) o configura le variabili nel pannello del tuo hosting, poi riprova.',
                'env-readonly-note'   => 'Questi valori vengono letti dall\'ambiente del tuo server (.env). Il programma di installazione non scrive mai la configurazione dell\'ambiente — per modificare qualcosa, modifica il file .env (o le variabili del pannello del tuo hosting) e ricarica questa pagina.',
                ...
                'usd'                 => 'Dollaro USA (USD)',
                'warning-message'     => 'La lingua e la valuta scelte qui diventano i valori predefiniti iniziali per il canale e l\'account amministratore. Puoi attivare altre lingue e valute, o modificare questi valori predefiniti, in qualsiasi momento dalle impostazioni di amministrazione.',
            ],
            ...
            'terminal' => [
                ...
                'install-failed'     => '✗ Installazione non riuscita. Controlla storage/logs/laravel.log per i dettagli.',
                'stream-interrupted' => '! La connessione al programma di installazione è stata persa. L\'installazione potrebbe essere ancora in fase di completamento — attendi un momento, poi ricarica questa pagina.',
            ],
