            ...
            <script type="text/x-template" id="v-server-requirements-template">
                ...
                <div class="flex flex-col justify-center">
                    <div class="grid items-end max-w-[362px] m-auto h-[100vh]">
                        ...
                        <p class="justify-end w-full text-left mb-[24px]">
                            <a
                                class="bg-white underline text-violet-700"
                                href="https://unopim.com/en/"
                            >
                ...
                <div class="w-full max-w-[568px] bg-white rounded-lg shadow-[0px_8px_10px_0px_rgba(0,0,0,0.05)] border-[1px] border-gray-300" v-if="currentStep == 'systemRequirements'">
                    ...
                    <div class="flex px-4 py-2.5 justify-between items-center">
                        ...
                        <div
                            class="{{ $hasRequirement ? 'opacity-50 cursor-not-allowed' : ''}} px-3 py-1.5 bg-violet-700 border border-violet-700 rounded-md text-gray-50 font-semibold cursor-pointer {{ $hasRequirement ?: 'hover:opacity-90' }}"
                            @click="nextForm"
                            tabindex="0"
                        >
                            @lang('installer::app.installer.index.continue')
                    ...
                    <div class="flex flex-col gap-[15px] justify-center px-[30px] py-4 h-[484px] overflow-y-auto">
                        <div class="flex flex-col gap-4">
                            <p class="text-[18px] text-gray-800 font-bold">
                                @lang('installer::app.installer.index.installation-processing.unopim')
                            </p>
                            ...
                            <div class="grid gap-2.5">
                                ...
                                <p class="text-[14px] text-gray-600">
                                    @lang('installer::app.installer.index.installation-processing.unopim-info')
                                </p>
                            </div>
                        </div>
                    </div>
