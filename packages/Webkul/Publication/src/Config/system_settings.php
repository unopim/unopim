...
| group rather than relocating saved data under a new key. Reuses the
| existing `configuration.system_settings` permission — no package-specific
| ACL key is needed until a later task adds its own admin surface.
|
*/
