    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'enabled-hint'                     => '공개 제공 계층의 마스터 스위치입니다. 꺼져 있으면 모든 공개 여권 URL이 404를 반환합니다. 관리자 여권 화면에는 영향을 주지 않으며, 숨기려면 디지털 제품 여권 설정을 사용하세요.',
                ...
                'cache-ttl-hint'                   => '공유 캐시(CDN 또는 리버스 프록시)가 렌더링된 공개 여권을 재사용할 수 있는 시간입니다. 브라우저는 방문할 때마다 재검증하므로 수정, 철회, 계층 비활성화가 즉시 반영됩니다.',
                ...
                'gs1-passport-channel'             => 'GS1 디지털 링크 여권 채널',
                'gs1-passport-channel-hint'        => '하나의 제품이 여러 채널에 게시된 경우 스캔한 GS1 바코드(/01/{gtin})가 연결되는 채널입니다. 비워 두면 첫 번째 활성화된 채널이 사용됩니다.',
                'gs1-passport-channel-placeholder' => '첫 번째 활성화된 채널 (자동)',
            ],
        ],
    ],
