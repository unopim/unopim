    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'indexable'                        => '允許搜尋引擎索引',
                'enabled-hint'                     => '公開服務層的總開關。關閉時，每個公開護照 URL 都會回傳 404。管理後台的護照頁面不受影響，如需隱藏請使用數位產品護照設定。',
                'base-url-hint'                    => '提供護照的公開位址，用於產生 QR 碼和可分享連結。留空則使用本站自身的網域。',
                'base-url-placeholder'             => 'https://dpp.example.com',
                'cache-ttl-hint'                   => '共用快取（CDN 或反向代理）可重複使用已算繪公開護照頁面的時間長度。瀏覽器每次造訪都會重新驗證，因此編輯、撤回以及關閉該層都會立即生效。',
