    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'cache-ttl-hint'                   => 'Berapa lama cache bersama (CDN atau reverse proxy) boleh memakai ulang paspor publik yang sudah dirender. Peramban memvalidasi ulang setiap kunjungan, sehingga suntingan, penarikan, dan mematikan tingkat ini langsung berlaku.',
                ...
                'gs1-passport-channel'             => 'Saluran paspor GS1 Digital Link',
                'gs1-passport-channel-hint'        => 'Saluran yang dituju barkode GS1 yang dipindai (/01/{gtin}) ketika satu produk diterbitkan di beberapa saluran. Biarkan kosong untuk menggunakan saluran aktif pertama.',
                'gs1-passport-channel-placeholder' => 'Saluran aktif pertama (otomatis)',
            ],
        ],
    ],
