    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'cache-ttl-hint'                   => 'Durée pendant laquelle un cache partagé (CDN ou proxy inverse) peut réutiliser un passeport public déjà rendu. Les navigateurs revalident à chaque visite : les modifications, les retraits et la désactivation du niveau prennent effet immédiatement.',
                ...
                'gs1-passport-channel'             => 'Canal de passeport GS1 Digital Link',
                'gs1-passport-channel-hint'        => 'Le canal vers lequel un code-barres GS1 scanné (/01/{gtin}) est résolu lorsqu’un produit est publié sur plusieurs canaux. Laissez vide pour utiliser le premier canal activé.',
                'gs1-passport-channel-placeholder' => 'Premier canal activé (automatique)',
            ],
        ],
    ],
    'publications' => [
