    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'cache-ttl-hint'                   => 'Por quanto tempo um cache compartilhado (CDN ou proxy reverso) pode reutilizar um passaporte público já renderizado. Os navegadores revalidam a cada visita, então edições, retiradas e desligar a camada valem imediatamente.',
                ...
                'gs1-passport-channel'             => 'Canal de passaporte GS1 Digital Link',
                'gs1-passport-channel-hint'        => 'O canal para o qual um código de barras GS1 lido (/01/{gtin}) é resolvido quando um produto é publicado em vários canais. Deixe em branco para usar o primeiro canal ativado.',
                'gs1-passport-channel-placeholder' => 'Primeiro canal ativado (automático)',
            ],
        ],
    ],
