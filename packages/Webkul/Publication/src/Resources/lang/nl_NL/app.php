    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'cache-ttl-hint'                   => 'Hoelang een gedeelde cache (CDN of reverse proxy) een gerenderd openbaar paspoort mag hergebruiken. Browsers valideren bij elk bezoek opnieuw, dus wijzigingen, intrekkingen en het uitschakelen van de laag werken direct.',
