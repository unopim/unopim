    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'gs1-passport-channel-hint'        => 'Den kanal, som en scannet GS1-stregkode (/01/{gtin}) henviser til, når ét produkt udgives på flere kanaler. Lad feltet stå tomt for at bruge den første aktiverede kanal.',
                'gs1-passport-channel-placeholder' => 'Første aktiverede kanal (automatisk)',
            ],
        ],
    ],
