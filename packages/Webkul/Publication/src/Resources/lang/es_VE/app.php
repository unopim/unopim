    ...
    'configuration' => [
        'publication' => [
            ...
            'settings' => [
                ...
                'enabled'                          => 'Habilitado',
                'enabled-hint'                     => 'Interruptor principal de la capa de servicio público. Cuando está desactivado, todas las URL públicas de pasaportes devuelven 404. Las pantallas de pasaportes del administrador no se ven afectadas: ocúltalas con la configuración de Pasaporte Digital de Producto.',
                'base-url'                         => 'URL base',
                ...
                'cache-ttl-hint'                   => 'Cuánto tiempo puede una caché compartida (CDN o proxy inverso) reutilizar un pasaporte público ya renderizado. Los navegadores revalidan en cada visita, por lo que las ediciones, los retiros y desactivar la capa surten efecto de inmediato.',
