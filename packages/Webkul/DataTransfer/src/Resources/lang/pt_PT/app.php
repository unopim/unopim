...
return [
    'samples' => [
        'default'       => 'Ficheiro de exemplo',
        'variants'      => 'Exemplo de variantes',
        'multi-locale'  => 'Exemplo multi-idioma',
        'delete'        => 'Exemplo de eliminação',
        ...
        'product-associations' => [
            ...
            'validation' => [
                'errors' => [
                    ...
                    'self-link-not-allowed'       => 'O produto \'%s\' não pode ser associado a si próprio.',
                    'sku-not-found'               => 'Produto com SKU \'%s\' não encontrado.',
                    'related-sku-not-found'       => 'Produto associado com SKU \'%s\' não encontrado.',
    ...
    'exporters' => [
        ...
        'fields'           => [
            ...
            'file-name-info' => 'Padrão do nome do ficheiro. Variáveis: [code], [date], [time], [entity_type]',
            'file-path'      => 'Nome do ficheiro',
            'file-path-info' => 'Padrão do nome do ficheiro. Variáveis: [code], [date], [time], [entity_type]',
            'status'         => 'Estado',
            'enable'         => 'Ativado',
            'all'            => 'Todos',
        ],
    ...
    'validation' => [
        'errors' => [
            ...
            'file-missing'           => 'O ficheiro de origem desta tarefa não foi encontrado. Verifique o caminho do ficheiro no perfil e carregue o ficheiro novamente.',
        ],
    ],
    'job' => [
