...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                ...
                'enabled'                      => 'Đã bật',
                'enabled-hint'                 => 'Bật tính năng Hộ chiếu Sản phẩm Số cho danh mục này. Khi tắt, menu hộ chiếu, danh sách và bảng sản phẩm sẽ bị ẩn và các tuyến của chúng trả về 404.',
    ...
    'publications' => [
        ...
        'datagrid' => [
            ...
            'reinstate'       => 'Khôi phục',
            'mass-transition' => 'Thu hồi / khôi phục mục đã chọn',
        ],
        ...
        'public-access-disabled'      => 'Xuất bản công khai đang tắt cho kênh này, nên hộ chiếu đã xuất bản sẽ trả về lỗi 404. Hãy bật trong Cấu hình → Xuất bản → Cài đặt rồi xuất bản lại.',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => 'Không truy cập công khai được',
                    'public-access-settings' => 'Mở cài đặt xuất bản',
