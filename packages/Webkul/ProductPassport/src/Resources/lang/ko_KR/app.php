...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                'title'                        => '제품 여권 설정',
                'enabled'                      => '활성화됨',
                'enabled-hint'                 => '이 카탈로그에서 디지털 제품 여권 기능을 켭니다. 꺼져 있으면 여권 메뉴, 목록, 제품 패널이 숨겨지고 해당 라우트는 404를 반환합니다.',
    ...
    'publications' => [
        ...
        'public-access-disabled'      => '이 채널의 공개 게시가 꺼져 있어 게시된 패스포트는 404를 반환합니다. 구성 → 게시 → 설정에서 켜거나 다시 게시하세요.',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => '외부에 공개되지 않음',
                    'public-access-settings' => '게시 설정 열기',
