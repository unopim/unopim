...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                ...
                'enabled'                      => 'Enabled',
                'enabled-hint'                 => 'Turn the Digital Product Passport feature on for this catalog. When off, the Passports menu, grid and product panel are hidden and their routes return 404.',
    ...
    'publications' => [
        ...
        'datagrid' => [
            ...
            'reinstate'       => 'Reinstate',
            'mass-transition' => 'Withdraw / reinstate selected',
        ],
        ...
        'public-access-disabled'      => 'Public publication is off for this channel, so a published passport would return 404. Turn it on under Configuration → Publication → Settings, then publish.',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => 'Not publicly reachable',
                    'public-access-settings' => 'Open publication settings',
