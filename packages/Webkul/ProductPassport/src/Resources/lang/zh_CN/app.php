...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                'title'                        => '产品护照设置',
                'enabled'                      => '已启用',
                'enabled-hint'                 => '为此目录启用数字产品护照功能。关闭时，护照菜单、列表和产品面板都会被隐藏，其路由返回 404。',
    ...
    'publications' => [
        ...
        'public-access-disabled'      => '该渠道的公开发布已关闭，已发布的护照将返回 404。请在 配置 → 发布 → 设置 中开启后再发布。',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => '未公开可访问',
                    'public-access-settings' => '打开发布设置',
