...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                ...
                'enabled'                      => 'Aktiverad',
                'enabled-hint'                 => 'Slå på funktionen Digitalt produktpass för den här katalogen. När den är av döljs passmenyn, listan och produktpanelen, och deras rutter returnerar 404.',
    ...
    'publications' => [
        ...
        'public-access-disabled'      => 'Offentlig publicering är avstängd för den här kanalen, så ett publicerat pass skulle ge 404. Slå på den under Konfiguration → Publicering → Inställningar och publicera sedan.',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => 'Inte offentligt tillgänglig',
                    'public-access-settings' => 'Öppna publiceringsinställningar',
