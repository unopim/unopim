...
return [
    ...
    'mapping' => [
        ...
        'custom-remove'           => 'Ta bort fält',
        'custom-empty'            => 'Inga anpassade fält har lagts till ännu.',
        ...
        'custom-media-source'     => 'Ett anpassat fält kan inte använda ett fil- eller bildattribut som källa; välj ett värdeattribut.',
