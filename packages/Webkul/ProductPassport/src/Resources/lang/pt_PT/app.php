...
return [
    ...
    'mapping' => [
        ...
        'regulatory-heading'      => 'Campos regulamentares',
        'custom-heading'          => 'Campos personalizados',
        'custom-info'             => 'Publique um atributo que já mantém com uma etiqueta à sua escolha.',
        'custom-name-placeholder' => 'Nome do campo',
        'custom-remove'           => 'Remover campo',
        'custom-empty'            => 'Ainda não foram adicionados campos personalizados.',
        ...
        'custom-media-source'     => 'Um campo personalizado não pode usar um atributo de ficheiro ou imagem como origem; escolha um atributo de valor.',
