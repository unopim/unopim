...
return [
    ...
    'mapping' => [
        ...
        'regulatory-heading'      => 'Campos regulatórios',
        'custom-heading'          => 'Campos personalizados',
        'custom-info'             => 'Publique um atributo que você já mantém com um rótulo à sua escolha.',
        'custom-name-placeholder' => 'Nome do campo',
        'custom-remove'           => 'Remover campo',
        'custom-empty'            => 'Nenhum campo personalizado adicionado ainda.',
        ...
        'custom-media-source'     => 'Um campo personalizado não pode usar um atributo de arquivo ou imagem como origem; escolha um atributo de valor.',
