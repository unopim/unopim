...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                'title'                        => '產品護照設定',
                'enabled'                      => '已啟用',
                'enabled-hint'                 => '為此目錄啟用數位產品護照功能。關閉時，護照選單、列表與產品面板都會被隱藏，其路由回傳 404。',
    ...
    'publications' => [
        ...
        'public-access-disabled'      => '此通路的公開發佈已關閉，已發佈的護照將回傳 404。請在 設定 → 發佈 → 設定 中開啟後再發佈。',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => '未公開可存取',
                    'public-access-settings' => '開啟發佈設定',
