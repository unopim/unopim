...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                ...
                'enabled'                      => 'Activado',
                'enabled-hint'                 => 'Activa la funcionalidad de Pasaporte Digital de Producto para este catálogo. Cuando está desactivada, el menú de pasaportes, la cuadrícula y el panel del producto se ocultan y sus rutas devuelven un 404.',
    ...
    'publications' => [
        ...
        'public-access-disabled'      => 'La publicación pública está desactivada para este canal, por lo que un pasaporte publicado devolvería un 404. Actívala en Configuración → Publicación → Ajustes y vuelve a publicar.',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'subtitle'               => 'Publica y haz seguimiento del pasaporte de este producto para cada idioma del canal.',
                    'version-history'        => 'Historial de versiones',
    ...
    'templates' => [
        ...
        'create' => [
            ...
            'info'             => 'Dé un nombre a la plantilla y elija sus familias y campos en la siguiente pantalla.',
            'name'             => 'Nombre',
        ...
        'preset' => [
            'battery' => [
                ...
                'sections' => [
                    ...
                    'compliance'  => 'Evidencias de conformidad',
                ],
                'fields' => [
                    ...
                    'battery_nominal_voltage'         => 'Tensión nominal',
                    'battery_weight'                  => 'Peso de la batería',
                    'battery_expected_lifetime'       => 'Vida útil prevista',
                    ...
                    'battery_recycled_cobalt'         => 'Proporción de cobalto reciclado',
                    'battery_recycled_lithium'        => 'Proporción de litio reciclado',
                    'battery_recycled_nickel'         => 'Proporción de níquel reciclado',
                    'battery_recycled_lead'           => 'Proporción de plomo reciclado',
                    'battery_safety_measures'         => 'Medidas de seguridad',
                    'battery_collection_information'  => 'Recogida y reciclaje',
                    ...
                    'battery_conformity_declaration'  => 'Declaración UE de conformidad',
