...
return [
    ...
    'configuration' => [
        'dpp-section' => [
            ...
            'info'  => 'Gestione la publicación de pasaportes y los ajustes de publicación pública.',
        ],
    ...
    'public' => [
        'preview' => [
            ...
            'note'             => 'Esta es una vista previa generada a partir de los datos actuales del producto. No se ha publicado nada y aún no existe ningún enlace público.',
            'document-pending' => 'Disponible tras la publicación',
        ],
    ...
    'mapping' => [
        'add-field'               => 'Añadir campo de pasaporte',
        ...
        'custom-empty'            => 'Aún no se han añadido campos personalizados.',
