...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                ...
                'enabled'                            => 'Habilitado',
                'enabled-hint'                       => 'Activa la función de Pasaporte Digital del Producto para este catálogo. Cuando está desactivada, el panel y la cuadrícula de pasaportes se ocultan.',
                ...
                'completeness-threshold-hint'        => 'Completitud mínima del producto, en porcentaje, requerida antes de poder publicar un pasaporte para un idioma.',
    ...
    'mapping' => [
        ...
        'custom-remove'           => 'Eliminar campo',
        'custom-empty'            => 'Aún no se han agregado campos personalizados.',
        ...
        'custom-media-source'     => 'Un campo personalizado no puede usar un atributo de archivo o imagen como origen; elija un atributo de valor.',
