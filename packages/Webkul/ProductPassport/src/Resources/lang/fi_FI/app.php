...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                ...
                'enabled'                      => 'Käytössä',
                'enabled-hint'                 => 'Ota digitaalinen tuotepassi käyttöön tässä luettelossa. Kun se on pois päältä, passivalikko, luettelonäkymä ja tuotepaneeli piilotetaan ja niiden reitit palauttavat 404-virheen.',
    ...
    'publications' => [
        ...
        'datagrid' => [
            ...
            'reinstate'       => 'Palauta',
            'mass-transition' => 'Peruuta / palauta valitut',
        ],
        ...
        'public-access-disabled'      => 'Julkinen julkaisu on pois käytöstä tässä kanavassa, joten julkaistu passi palauttaisi virheen 404. Ota se käyttöön kohdassa Asetukset → Julkaisu → Asetukset ja julkaise sitten.',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => 'Ei julkisesti saatavilla',
                    'public-access-settings' => 'Avaa julkaisuasetukset',
