...
return [
    ...
    'configuration' => [
        ...
        'product_passport' => [
            ...
            'settings' => [
                ...
                'enabled'                      => 'Pinagana',
                'enabled-hint'                 => 'I-on ang tampok na Digital Product Passport para sa katalogong ito. Kapag naka-off, nakatago ang menu ng passport, ang grid at ang panel ng produkto, at nagbabalik ng 404 ang mga ruta ng mga ito.',
    ...
    'publications' => [
        ...
        'public-access-disabled'      => 'Naka-off ang pampublikong paglalathala para sa channel na ito, kaya magbabalik ng 404 ang nailathalang passport. I-on ito sa Configuration → Publication → Settings, pagkatapos ay ilathala.',
        ...
        'products' => [
            'edit' => [
                'passport' => [
                    ...
                    'public-access-badge'    => 'Hindi naa-access ng publiko',
                    'public-access-settings' => 'Buksan ang mga setting ng paglalathala',
