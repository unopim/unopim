...
test.describe('UnoPim Export Jobs', () => {
  ...
  test('create Locale export with CSV, switch to XLS, then delete', async ({ adminPage }) => {

    const uniqueCode = 'Locale Export CSV ' + Math.random().toString(36).slice(2, 6);
