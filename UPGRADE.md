...
├── releases/3.1.1/     ← the new release
...
curl -fL -o unopim.zip https://github.com/unopim/unopim/archive/refs/tags/v3.1.1.zip
unzip -q unopim.zip
mv unopim-3.1.1 3.1.1
rm unopim.zip
```
...
```bash
cd /var/www/unopim/releases/3.1.1
