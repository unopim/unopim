...
├── releases/3.1.2/     ← the new release
└── current -> releases/3.1.2
```
...
curl -fL -o unopim.zip https://github.com/unopim/unopim/archive/refs/tags/v3.1.2.zip
unzip -q unopim.zip
mv unopim-3.1.2 3.1.2
rm unopim.zip
```
...
```bash
cd /var/www/unopim/releases/3.1.2
