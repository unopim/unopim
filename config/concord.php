...
return [
    ...
    'modules' => [
        ...
        \Webkul\Magento2\Providers\Magento2ServiceProvider::class,
        \Webkul\Amazon\Providers\AmazonServiceProvider::class,
        \Webkul\Ebay\Providers\EbayServiceProvider::class,
        \Webkul\Noon\Providers\NoonServiceProvider::class,
    ],
];
